...
{
    public partial class LeCodigoBarraProdutoArquivo : System.Web.UI.Page
    {
        ...
        private void CriarIdTransferencia()
        {
            ...
            var pt = baseController.ObterProdutoTransferencia(codigoUsuario).Where(p => p.DATA_ENVIO == null).FirstOrDefault();
            if (pt == null)
            {
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (codigoFilial == "1029" || codigoFilial == "000041" || codigoFilial == "000029" || codigoFilial == "1054")
                    ProcessarDevInterna();
                else
