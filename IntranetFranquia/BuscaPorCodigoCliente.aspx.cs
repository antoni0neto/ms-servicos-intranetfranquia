...
{
    public partial class BuscaPorCodigoCliente : System.Web.UI.Page
    {
        ...
        private void CarregaGridViewAtacado(string colecao, string codigoCliente)
        {
            GridViewAtacado.DataSource = baseController.BuscaCodigoGestaoAtacado(colecao, codigoCliente);
        ...
        protected void btBuscar_Click(object sender, EventArgs e)
        {
            if (ddlColecao.SelectedValue.ToString().Equals("0") || 
                ...
                txtCodigoCliente.Text.Equals("")) 
                 return;

            CarregaGridViewAtacado(ddlColecao.SelectedValue, txtCodigoCliente.Text);

        }

        protected void GridViewAtacado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            Sp_Codigo_Gestao_AtacadoResult sp_Gestao_AtacadoResult = e.Row.DataItem as Sp_Codigo_Gestao_AtacadoResult;
