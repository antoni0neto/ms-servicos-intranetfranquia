<%@ Page Title="Vendas do Atacado por Grupo de Produto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VendasAtacadoPorGrupo.aspx.cs" Inherits="Relatorios.VendasAtacadoPorGrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="accountInfo">
        ...
        <fieldset class="login">
            <div style="width: 800px;" class="alinhamento">
                <div style="width: 200px;"  class="alinhamento">
                    ...
                    <asp:DropDownList runat="server" ID="ddlTipoProduto" Height="22px" Width="198px">
                        <asp:ListItem>Selecione</asp:ListItem>
                        <asp:ListItem>C-MAX%</asp:ListItem>
                        <asp:ListItem>IMPORTADO_HBF%</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div style="width: 200px;"  class="alinhamento">
                    <label>Coleção:&nbsp; </label>
        ...
        <fieldset class="login">
            <asp:GridView id="GridViewJanela1" runat="server" Width="100%" AutoGenerateColumns="False" ShowFooter="true" ForeColor="#333333" 
                                             onrowdatabound="GridViewJanela1_RowDataBound" style="background:white">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Origem">
                        <ItemTemplate>
                            <asp:Literal runat="server" ID="LiteralOrigem"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Griffe">
                        <ItemTemplate>
                            <asp:Literal runat="server" ID="LiteralGriffe"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="GRUPO_PRODUTO" HeaderText="Grupo de Produto" />
