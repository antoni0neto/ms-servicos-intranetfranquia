...
{
    public partial class VendasPorCotaLoja : System.Web.UI.Page
    {
        ...
        private void CarregarCotasVendas()
        {
            ...
            if (filiais != null && filiais.Count > 0)
            {
                ...
                vendasCotas = baseController.ObterVendasCotas("", CalendarDataInicio.SelectedDate, CalendarDataFim.SelectedDate);
                ...
                if (vendasCotas != null && vendasCotas.Count > 0)
                {
                    ...
                    gvVendas.DataSource = vendasCotas;
                    gvVendas.DataBind();
                }
            }
        }
        protected void btBuscarVendas_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                labErro.Text = "";
                if (txtDataInicio.Text.Trim() == "" && txtDataFim.Text.Trim() == "")
                {
