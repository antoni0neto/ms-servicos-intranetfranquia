<%@ Page Title="Venda/Cotas por Loja" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="gerloja_venda_cota_loja.aspx.cs" Inherits="Relatorios.gerloja_venda_cota_loja" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <span style="font-family: Calibri; font-size: 14px;">
            <asp:Label ID="labTitulo" runat="server" Text="Módulo de Gerenciamento de Loja&nbsp;&nbsp;>&nbsp;&nbsp;Desempenho&nbsp;&nbsp;>&nbsp;&nbsp;Venda/Cotas por Loja (COM VALE MERCADORIA)"></asp:Label></span>
    ...
    <div>
        <fieldset>
            <legend>Venda/Cotas por Loja (COM VALE MERCADORIA)</legend>
