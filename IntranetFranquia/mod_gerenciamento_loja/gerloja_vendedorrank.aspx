<%@ Page Title="Ranking de Vendedores" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="gerloja_vendedorrank.aspx.cs" Inherits="Relatorios.gerloja_vendedorrank" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Gerenciamento de Loja&nbsp;&nbsp;>&nbsp;&nbsp;Vendedores&nbsp;&nbsp;>&nbsp;&nbsp;Ranking de Vendedores</span>
                    ...
                    <tr>
                        <td>
                            <fieldset style="padding-top: 0;">
                                <legend>Ranking de Vendedores</legend>
                                <br />
                                <div id="accordionR">
                                    <h6>
                                                    ...
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvPontoSemana" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="PA_PONTO" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                    HeaderText="PA" HeaderStyle-Width="100px" />
                                ...
                                <br />
                                <div id="accordionA">
                                    <h3>Pontos Acumulados - Início - 25/07/2019</h3>
                                    <div>
                                        <table border="0" cellpadding="0" class="tb" width="100%">
                                            <tr>
                                                <td style="width: 100%;">
