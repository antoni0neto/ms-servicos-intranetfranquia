...
{
    public partial class gerloja_venda_cota_loja : System.Web.UI.Page
    {
        ...
        private void CarregarCotasVendas()
        {
            ...
            {
                List<SP_OBTER_VENDASCOTASResult> vendasCotas = null;

                vendasCotas = baseController.ObterVendasCotas("", Convert.ToDateTime(txtPeriodoInicial.Text), Convert.ToDateTime(txtPeriodoFinal.Text));
                ...
                {
                    vendasCotas = vendasCotas.GroupBy(p => new { DATA_VENDA = p.DATA_VENDA }).Select(x => new SP_OBTER_VENDASCOTASResult
                    {
                    ...
                    if (vendasCotas != null)
                    {
                        foreach (SP_OBTER_VENDASCOTASResult item in vendasCotas)
                        {
                    ...
                    SP_OBTER_VENDASCOTASResult vendaCota = null;

                    vendaCota = new SP_OBTER_VENDASCOTASResult();
                ...
                {
                    gvVendas.DataSource = new List<SP_OBTER_VENDASCOTASResult>();
                    gvVendas.DataBind();
                }
            }
        }
        ...
        {
            SP_OBTER_VENDASCOTASResult vendasCota = e.Row.DataItem as SP_OBTER_VENDASCOTASResult;
