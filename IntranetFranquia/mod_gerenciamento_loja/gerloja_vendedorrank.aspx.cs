...
{
    public partial class gerloja_vendedorrank : System.Web.UI.Page
    {
        ...
        {
            var rankAcum = lojaController.ObterVendedorRankingAcum();
        ...
        protected void gvPontoAcumulado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    SP_OBTER_VENDEDOR_RANKACUMResult rank = e.Row.DataItem as SP_OBTER_VENDEDOR_RANKACUMResult;
        ...
        {
            var rankSemana = lojaController.ObterVendedorRankingSemana();
        ...
        protected void gvPontoSemana_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.DataItem != null)
                {
                    SP_OBTER_VENDEDOR_RANKSEMANAResult rank = e.Row.DataItem as SP_OBTER_VENDEDOR_RANKSEMANAResult;
                    if (rank != null)
                    {
                        System.Web.UI.WebControls.Image imgCaricatura = e.Row.FindControl("imgCaricatura") as System.Web.UI.WebControls.Image;
                        imgCaricatura.ImageUrl = (rank.FOTO == null || rank.FOTO.Trim() == "") ? "~/Image/fun_sfoto.jpg" : rank.FOTO;
