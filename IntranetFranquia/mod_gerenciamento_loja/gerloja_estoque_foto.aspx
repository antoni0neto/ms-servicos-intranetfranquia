<%@ Page Title="Estoque Lojas" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="gerloja_estoque_foto.aspx.cs" Inherits="Relatorios.gerloja_estoque_foto"
                            ...
                            <div class="rounded_corners">
                                <asp:GridView ID="gvEstoqueLoja" runat="server" Width="100%" AutoGenerateColumns="False" ForeColor="#333333"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Nome" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="170px"
                                        ...
                                        <asp:TemplateField HeaderText="Venda" HeaderStyle-Width="90px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:BoundField HeaderText="ES1" DataField="ES1" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="ES2" DataField="ES2" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="ES3" DataField="ES3" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="ES4" DataField="ES4" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="ES5" DataField="ES5" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="ES6" DataField="ES6" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField HeaderText="ES7" DataField="ES7" ItemStyle-HorizontalAlign="Center" />
