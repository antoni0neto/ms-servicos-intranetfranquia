<%@ Page Title="Resultado de Peças" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"
    CodeBehind="cont_resultado_v2.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="Relatorios.cont_resultado_v2" %>
                                ...
                                <tr>
                                    <td style="width: 360px;">
                                        <asp:DropDownList runat="server" ID="ddlDataContagem" DataValueField="Value" DataTextField="Text"
                                            Height="23px" Width="354px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 260px;">
                                        <asp:TextBox ID="txtContagem" runat="server" CssClass="alinharDireira" Width="250px" onkeypress="return fnValidarNumero(event);"></asp:TextBox>
                                    </td>
                                    <td style="width: 160px;">
                                        <asp:TextBox ID="txtPorcValorAceitavel" runat="server" CssClass="alinharDireira" Text="0,50" Width="150px" onkeypress="return fnValidarNumeroDecimal(event);"></asp:TextBox>
                                    </td>
                                                ...
                                                <div class="rounded_corners">
                                                    <asp:GridView ID="gvResultadoContagem" runat="server" Width="100%" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Data" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Resultado de Peças" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:Literal ID="litResultadoPeca" runat="server" Text='<%# Bind("CONTAGEM") %>'></asp:Literal>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
