<%@ Page Title="Acabamento Diário" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="facc_fila_acabamento.aspx.cs" Inherits="Relatorios.facc_fila_acabamento" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Facção&nbsp;&nbsp;>&nbsp;&nbsp;Relatórios&nbsp;&nbsp;>&nbsp;&nbsp;Acabamento Diário</span>
            ...
            <div class="login">
                <fieldset style="padding-top: 0;">
                    <legend>Acabamento Diário</legend>
                                                    ...
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvRecebido" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="HB" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                    HeaderText="HB" HeaderStyle-Width="100px" SortExpression="HB" ItemStyle-Font-Size="Smaller" />
                                                                <asp:BoundField DataField="PRODUTO" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                    HeaderText="Produto" HeaderStyle-Width="100px" SortExpression="PRODUTO" ItemStyle-Font-Size="Smaller"/>
                                                                <asp:BoundField DataField="NOME" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderText="Nome" HeaderStyle-Width="150px" SortExpression="NOME" ItemStyle-Font-Size="Smaller" />
                                                                <asp:BoundField DataField="COR" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderText="Cor" HeaderStyle-Width="70px" SortExpression="COR" ItemStyle-Font-Size="Smaller" />
                                                                <asp:BoundField DataField="DESC_COR" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderText="Desc Cor" HeaderStyle-Width="150px" SortExpression="DESC_COR" ItemStyle-Font-Size="Smaller" />
                                                                ...
                                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                    HeaderText="Liberado" HeaderStyle-Width="80px">
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="cbLoja" runat="server" Checked="false" OnCheckedChanged="cbLoja_CheckedChanged" AutoPostBack="true" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
