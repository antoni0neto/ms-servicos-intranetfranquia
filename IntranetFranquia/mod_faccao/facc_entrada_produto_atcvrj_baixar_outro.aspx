<%@ Page Title="Baixar Entrada de Produto Atacado/Varejo" Language="C#" AutoEventWireup="true" CodeBehind="facc_entrada_produto_atcvrj_baixar_outro.aspx.cs"
    Inherits="Relatorios.facc_entrada_produto_atcvrj_baixar_outro" %>
                                        ...
                                        <fieldset>
                                            ...
                                            <asp:Panel ID="pnlOutro" runat="server">
                                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td style="width: 150px;" valign="middle">Segunda Qualidade
                                                        </td>
                                                        <td style="width: 80px;">
