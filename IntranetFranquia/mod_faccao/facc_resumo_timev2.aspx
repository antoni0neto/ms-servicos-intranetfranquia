<%@ Page Title="Time Facção" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="facc_resumo_timev2.aspx.cs" Inherits="Relatorios.facc_resumo_timev2"
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="width: 150px;">
                            <asp:DropDownList ID="ddlColecao" runat="server" Width="144px" Height="21px"
                        ...
                        <td style="width: 120px;">
                            <asp:DropDownList ID="ddlAtraso" runat="server" Width="114px" Height="21px">
                                <asp:ListItem Value="" Text=""></asp:ListItem>
                        ...
                        <td style="width: 180px;">
                            <asp:DropDownList ID="ddlStatus" runat="server" Width="174px" Height="21px" Enabled="false">
                            </asp:DropDownList>
                        </td>
                        <td>
                            ...
                            <div class="rounded_corners">
                                <asp:GridView ID="gvFaccaoHB" runat="server" Width="100%" AutoGenerateColumns="False" ForeColor="#333333"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="HB" HeaderStyle-Width="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            SortExpression="HB">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Atacado" HeaderStyle-Width="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:TemplateField HeaderText="Total" HeaderStyle-Width="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="labTotal" runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Faltante" HeaderStyle-Width="" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="labFaltante" runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Emissão" HeaderStyle-Width="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            SortExpression="EMISSAO">
                                            <ItemTemplate>
                                                <asp:Label ID="labEmissao" runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Previsão" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width=""
                                            SortExpression="PREVISAO_EM_DIAS">
                                            <ItemTemplate>
                                                <asp:Label ID="labQtdeDiasPrev" runat="server" Text='<%# Bind("PREVISAO_EM_DIAS") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Dias Atraso" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width=""
                                            SortExpression="ATRASO_EM_DIAS">
                                            <ItemTemplate>
                                                <asp:Label ID="labQtdeDiasAtraso" runat="server" Text='<%# Bind("ATRASO_EM_DIAS") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
