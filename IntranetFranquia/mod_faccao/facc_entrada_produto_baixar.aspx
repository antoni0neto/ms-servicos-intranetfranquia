<%@ Page Title="Baixar Entrada de Produto" Language="C#" AutoEventWireup="true" CodeBehind="facc_entrada_produto_baixar.aspx.cs"
    Inherits="Relatorios.facc_entrada_produto_baixar" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Facção&nbsp;&nbsp;>&nbsp;&nbsp;Controle de Facção&nbsp;&nbsp;>&nbsp;&nbsp;Entrada de Produto&nbsp;&nbsp;>&nbsp;&nbsp;Baixar Entrada de Produto</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Baixar Entrada de Produto</legend>
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="300px" Height="22px" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Value="" Text="Selecione"></asp:ListItem>
                                            <asp:ListItem Value="A" Text="AGUARDANDO GRADE"></asp:ListItem>
                                    ...
                                    <td colspan="7">
                                        <div id="divStatus" runat="server" visible="false">
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="labSubStatus" runat="server" Text="SubStatus"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="ddlSubStatus" runat="server" Width="300px" Height="22px">
                                                            <asp:ListItem Value="A" Text="GRADE TOTAL"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
