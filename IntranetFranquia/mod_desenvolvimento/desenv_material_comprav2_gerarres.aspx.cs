...
{
    public partial class desenv_material_comprav2_gerarres : System.Web.UI.Page
    {
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var pedidoIntra = desenvController.GerarPedidoCompraTecidoIntraReservado(fornecedor, ddlColecao.SelectedValue, Convert.ToDateTime(txtDataEntrega.Text), usuario.CODIGO_USUARIO);
                ...
                if (pedidoIntra != null && pedidoIntra.OK > 0)
                {
                    ...
                    labErro.Text = "Os pedidos foram atualizados com sucesso!";
                }
                else
                {
        ...
        public StringBuilder MontarPedidoCompraTecido(StringBuilder _texto, USUARIO usuario)
        {
            ...
            var pedidos = desenvController.ObterCarrinhoPedidoSubPorUsuario(usuario.CODIGO_USUARIO).OrderBy(p => p.DESENV_PEDIDO_SUB1.DESENV_PEDIDO1.SUBGRUPO).ThenBy(p => p.DESENV_PEDIDO_SUB1.DESENV_PEDIDO1.COR_FORNECEDOR);
            foreach (var p in pedidos)
            {
                ...
                _texto.Append("                            &nbsp;" + p.DESENV_PEDIDO_SUB1.DESENV_PEDIDO1.NUMERO_PEDIDO.ToString());
                _texto.Append("                        </td>");
                _texto.Append("                        <td style='border-right: 1px solid #000;'>");
                _texto.Append("                            &nbsp;" + p.DESENV_PEDIDO_SUB1.DESENV_PEDIDO1.SUBGRUPO.Trim());
                _texto.Append("                        </td>");
                _texto.Append("                        <td style='border-right: 1px solid #000;'>");
                _texto.Append("                            &nbsp;" + p.DESENV_PEDIDO_SUB1.DESENV_PEDIDO1.COR_FORNECEDOR.Trim());
                _texto.Append("                        </td>");
                ...
                _texto.Append("                        </td>");
                _texto.Append("                        <td style='border-right: 1px solid #000;' valign='top'>");
                _texto.Append("                            &nbsp;" + p.DESENV_PEDIDO_SUB1.DESENV_PEDIDO1.UNIDADE_MEDIDA1.DESCRICAO);
                _texto.Append("                        </td>");
                _texto.Append("                        <td style='border-right: 1px solid #000;' valign='top'>");
