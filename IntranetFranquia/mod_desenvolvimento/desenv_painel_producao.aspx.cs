...
{
    public partial class desenv_painel_producao : System.Web.UI.Page
    {
        ...
        private void CarregarPainel(string colecao)
        {
            ...
            try
            {
                ...
                fsModEDes.Visible = false;
                fs1peca.Visible = false;
                fsModelagem.Visible = false;
                fsPreRisco.Visible = false;
                fsRisco.Visible = false;
                fsCorte.Visible = false;
                fsEncFaccao.Visible = false;
                fsFaccao.Visible = false;
                fsEncAcabamento.Visible = false;
                fsAcabamento.Visible = false;
                tdModEDes.Visible = false;
                td1Peca.Visible = false;
                tdModelagem.Visible = false;
                tdPreRisco.Visible = false;
                tdRisco.Visible = false;
                tdCorte.Visible = false;
                tdEncFaccao.Visible = false;
                tdFaccao.Visible = false;
                tdEncAcabamento.Visible = false;
                tdAcabamento.Visible = false;

                if (cbModEDes.Checked)
                {
                    fsModEDes.Visible = true;
                    tdModEDes.Width = "700px";
                    CarregarDIVs(ObterDadosPainel(labTotMODeDES, "mod_e_design", colecao), pnlModEDes, false, "MOD e DESI", 1);
                }

                if (cb1Peca.Checked)
                {
                    fs1peca.Visible = true;
                    td1Peca.Width = "700px";
                ...
                {
                    fsEncFaccao.Visible = true;
                    tdEncFaccao.Width = "700px";
                ...
                {
                    fsAcabamento.Visible = true;
                    tdAcabamento.Width = "700px";
        ...
        private List<DESENV_PRODUTO> ObterDadosPainel(Label labTot, string local, string colecao)
        {
            ...
            labTot.Text = produtos.Count().ToString();
