<%@ Page Title="Editar Produto" Language="C#" AutoEventWireup="true" CodeBehind="desenv_tripa_editar.aspx.cs"
    Inherits="Relatorios.desenv_tripa_editar" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function handleDnDFileSelect(event) {
            ...
            xhr.open('POST', "desenv_tripa_editar.aspx");
            ...
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    ...
                    <div>
                        ...
                        de Coleção Nacional&nbsp;&nbsp;>&nbsp;&nbsp;Desenvolvimento de Coleção&nbsp;&nbsp;>&nbsp;&nbsp;Editar Produto</span>
                    ...
                    <div>
                        <fieldset>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>Origem<asp:HiddenField ID="hidCodigoProduto" runat="server" />
                                    </td>
                                    <td>Grupo
                                    </td>
                                    <td>Produto
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTecido" runat="server" Width="140px" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td>Preço Venda Varejo
                                    </td>
                                    <td>Preço Venda Atacado
                                    </td>
                                    <td>Brinde
                                    </td>
                                    <td>Produto Acabado
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px;">
                                        <asp:DropDownList ID="ddlProdutoAcabado" runat="server" Width="144px" Height="21px">
                                            <asp:ListItem Value="N" Text="Não" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="S" Text="Sim"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
