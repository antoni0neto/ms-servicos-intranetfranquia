<%@ Page Title="Liberação Aviamento por HB" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="desenv_pedido_aviamento_hb_saq_liberado.aspx.cs" Inherits="Relatorios.desenv_pedido_aviamento_hb_saq_liberado" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Desenvolvimento&nbsp;&nbsp;>&nbsp;&nbsp;Aviamentos&nbsp;&nbsp;>&nbsp;&nbsp;Liberação de Aviamento por HB</span>
            ...
            <div class="login">
                <fieldset style="padding-top: 0;">
                    <legend>Liberação de Aviamento por HB</legend>
                    <br />
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlLiberado" runat="server" Width="120px" Height="21px">
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="rounded_corners">
                                    <asp:GridView ID="gvMaterialLib" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ForeColor="#333333" Style="background: white" OnRowDataBound="gvMaterialLib_RowDataBound" ShowFooter="true"
                                        DataKeyNames="COD_PROD_AVIAMENTO">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                HeaderText="Qtde" HeaderStyle-Width="130px" SortExpression="QTDE_TOTAL">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                HeaderText="Liberado" HeaderStyle-Width="130px" SortExpression="AVIAMENTO_LIB">
                                                <ItemTemplate>
                                                    <asp:Literal ID="litDataAviamentoLib" runat="server"></asp:Literal>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Button ID="btnBaixar" runat="server" Width="80px" Text="Liberado" OnClick="btnBaixar_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
