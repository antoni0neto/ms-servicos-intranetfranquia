<%@ Page Title="Gerar Pedido LINX Material" Language="C#" AutoEventWireup="true" CodeBehind="desenv_pedido_aviamento_linx_gerar.aspx.cs"
    Inherits="Relatorios.desenv_pedido_aviamento_linx_gerar" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Desenvolvimento&nbsp;&nbsp;>&nbsp;&nbsp;Aviamentos&nbsp;&nbsp;>&nbsp;&nbsp;Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Gerar Pedido Linx</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Linx - Pedido Aviamento</legend>
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="2">
                                        <asp:HiddenField ID="hidCodigoCarrinhoLinxCab" runat="server" Value="" />
                                        <asp:HiddenField ID="hidPedidoTipo" runat="server" Value="" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <div class="rounded_corners">
                                                <asp:GridView ID="gvCarrinho" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                            HeaderText="Custo Unit" HeaderStyle-Width="100px">
                                                            <ItemTemplate>
                                                                <asp:Literal ID="litCusto" runat="server"></asp:Literal>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                            HeaderText="Desconto Unit" HeaderStyle-Width="100px">
                                                            <ItemTemplate>
