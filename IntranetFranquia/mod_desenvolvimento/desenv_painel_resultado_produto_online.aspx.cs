...
{
    public partial class desenv_painel_resultado_produto_online : System.Web.UI.Page
    {
        ...
        const string PAINEL_RESULTADO_PRODUTO = "PAINEL_RESULTADO_PRODUTO_ONLINE";
        ...
        private List<SP_OBTER_PAINEL_RESULTADO_PRODUTO_ONLINEResult> ObterPainelResultadoProduto()
        {
            ...
            var resProduto = lojaController.ObterPainelResultadoProdutoOnline(dataIni, dataFim, colecaoLinxCon, ddlColecaoOrigem.SelectedValue, txtProduto.Text.Trim(), griffeCon, ddlGrupo.SelectedValue, ddlTipo.SelectedValue);
        ...
        protected void gvResultadoProduto_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    SP_OBTER_PAINEL_RESULTADO_PRODUTO_ONLINEResult res = e.Row.DataItem as SP_OBTER_PAINEL_RESULTADO_PRODUTO_ONLINEResult;
        ...
        {
            IEnumerable<SP_OBTER_PAINEL_RESULTADO_PRODUTO_ONLINEResult> resultadoProduto;

            if (Session[PAINEL_RESULTADO_PRODUTO] != null)
                resultadoProduto = (IEnumerable<SP_OBTER_PAINEL_RESULTADO_PRODUTO_ONLINEResult>)Session[PAINEL_RESULTADO_PRODUTO];
            else
