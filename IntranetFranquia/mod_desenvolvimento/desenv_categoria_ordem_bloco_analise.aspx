<%@ Page Title="Análise de Produtos na Categoria" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"
    CodeBehind="desenv_categoria_ordem_bloco_analise.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="Relatorios.desenv_categoria_ordem_bloco_analise" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Desenvolvimento&nbsp;&nbsp;>&nbsp;&nbsp;Análise de Coleção&nbsp;&nbsp;>&nbsp;&nbsp;Análise de Produtos na Categoria</span>
            ...
            <div style="width: 90%; margin-left: 5%;">
                <fieldset>
                    <legend>Análise de Produtos na Categoria</legend>
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="tb">
                        ...
                        <tr>
                            ...
                            <td style="width: 260px;">
                                <asp:ListBox ID="lstCategoria" runat="server" DataValueField="CODIGO" DataTextField="NOME" SelectionMode="Multiple" Width="254px" Height="110px"></asp:ListBox>
                            </td>
                            <td valign="top">
