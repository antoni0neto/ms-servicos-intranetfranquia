<%@ Page Title="Liberar Produtos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="desenv_pocket_con_gemeav2.aspx.cs" Inherits="Relatorios.desenv_pocket_con_gemeav2"
            ...
            <fieldset>
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlLiberado1Peca" runat="server" Width="204px" Height="21px">
                                <asp:ListItem Value="" Text=""></asp:ListItem>
                                <asp:ListItem Value="S" Text="Sim"></asp:ListItem>
                                <asp:ListItem Value="N" Text="Não"></asp:ListItem>
                            </asp:DropDownList>
                        ...
                        <td colspan="4">
                            <asp:DropDownList ID="ddlLiberadoGemea" runat="server" Width="204px" Height="21px">
                                <asp:ListItem Value="" Text=""></asp:ListItem>
                                <asp:ListItem Value="S" Text="Sim"></asp:ListItem>
                                <asp:ListItem Value="N" Text="Não"></asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td colspan="9" style="text-align: right;">&nbsp;
                            ...
                            <asp:Button ID="btImprimir" runat="server" Text="Liberar" Width="100px" OnClick="btImprimir_Click" OnClientClick="DesabilitarBotao(this);" />&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td colspan="10">&nbsp;
                    ...
                    <tr>
                        <td colspan="10" style="text-align: left; line-height: 22px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="cbLiberarTodos1Peca" runat="server" OnCheckedChanged="cbLiberarTodos_CheckedChanged" AutoPostBack="true" Checked="false"  />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="cbLiberarTodosGemea" runat="server" OnCheckedChanged="cbLiberarTodos_CheckedChanged" AutoPostBack="true" Checked="false"  />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="10">
                            <div class="rounded_corners">
                                <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="cbLiberar1Peca" runat="server" Checked="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Data Lib 1ª Peça" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Literal ID="litDataLiberacao1Peca" runat="server"></asp:Literal>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="cbLiberarGemea" runat="server" Checked="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Data Lib Gêmea" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Literal ID="litDataLiberacaoGemea" runat="server"></asp:Literal>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                                ...
                                                <table border='0' cellpadding='0' cellspacing='0' width='950px'>
                                                    <tr>
                                                        <td colspan='2' style='border-bottom: 1px solid #696969; line-height: 26px;'>&nbsp;&nbsp;
                                                            <asp:Label ID="labOrigem" runat="server" ForeColor="Red" Font-Bold="true" Text="" Font-Size=""></asp:Label>
