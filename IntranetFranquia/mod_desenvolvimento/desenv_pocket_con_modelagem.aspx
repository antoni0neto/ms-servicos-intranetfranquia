<%@ Page Title="Liberar Modelagem" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="desenv_pocket_con_modelagem.aspx.cs" Inherits="Relatorios.desenv_pocket_con_modelagem"
        ...
        <ContentTemplate>
            ...
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Desenvolvimento&nbsp;&nbsp;>&nbsp;&nbsp;Planejamento
                    de Coleção Nacional&nbsp;&nbsp;>&nbsp;&nbsp;Liberar Modelagem</span>
            ...
            <fieldset>
                <legend>
                    <asp:Label ID="labTitulo" runat="server" Text="Liberar Modelagem"></asp:Label></legend>
                            ...
                            <div class="rounded_corners">
                                <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Data Liberação" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Literal ID="litDataModelagem" runat="server"></asp:Literal>
                                            </ItemTemplate>
                                        </asp:TemplateField>
