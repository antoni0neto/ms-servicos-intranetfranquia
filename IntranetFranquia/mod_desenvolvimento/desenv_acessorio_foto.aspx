<%@ Page Title="Foto Acessório" Language="C#" AutoEventWireup="true" CodeBehind="desenv_acessorio_foto.aspx.cs"
    Inherits="Relatorios.desenv_acessorio_foto" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function handleDnDFileSelect(event) {
            ...
            xhr.open('POST', "desenv_acessorio_foto.aspx");
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            ...
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Desenvolvimento&nbsp;&nbsp;>&nbsp;&nbsp;Planejamento de Coleção de Acessórios&nbsp;&nbsp;>&nbsp;&nbsp;Desenvolvimento de Coleção de Acessórios&nbsp;&nbsp;>&nbsp;&nbsp;Foto
                        Acessório</span>
