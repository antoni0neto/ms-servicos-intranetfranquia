<%@ Page Title="Ajuste - Estoque de Aviamentos" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="desenv_pedido_aviamento_estoque_manut.aspx.cs" Inherits="Relatorios.desenv_pedido_aviamento_estoque_manut"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Desenvolvimento&nbsp;&nbsp;>&nbsp;&nbsp;Aviamentos&nbsp;&nbsp;>&nbsp;&nbsp;Ajuste - Estoque de Aviamentos</span>
            ...
            <div style="float: left; width: 1200px; margin-left: 8%;">
                <fieldset>
                    <legend>Ajuste - Estoque de Aviamentos</legend>
                            ...
                            <td style="width: 100%;">
                                <div class="rounded_corners">
                                    <asp:GridView ID="gvEstoqueAviamento" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ForeColor="#333333" Style="background: white" OnRowDataBound="gvEstoqueAviamento_RowDataBound"
                                        DataKeyNames="MATERIAL, COR_MATERIAL">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                HeaderText="Unidade" HeaderStyle-Width="80px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                HeaderText="Qtde de Ajuste" HeaderStyle-Width="120px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtQtdeAjuste" runat="server" Width="120" CssClass="alinharCentro" onkeypress="return fnValidarNumeroDecimalNegativo(event);"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Button ID="btAjustarEstoque" runat="server" Width="100px" Text="Ajustar" OnClick="btAjustarEstoque_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
