...
{
    public partial class BuscaPorRepresentante : System.Web.UI.Page
    {
        ...
        {
            ddlRepresentante.DataSource = baseController.BuscaRepresentanteAtacado();
            ddlRepresentante.DataBind();
        }

        protected void ddlRepresentante_DataBound(object sender, EventArgs e)
        {
            ddlRepresentante.Items.Add(new ListItem("Selecione", "0"));
            ddlRepresentante.SelectedValue = "0";
        }

        private void CarregaGridViewAtacado(string colecao, string nomeRepresentante)
        {
            GridViewAtacado.DataSource = baseController.BuscaNomeRepresentanteAtacado(colecao, nomeRepresentante);
        ...
        protected void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            CarregaGridViewAtacado(ddlColecao.SelectedValue, ddlRepresentante.SelectedValue);

        }

        protected void GridViewAtacado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            Sp_Nome_Representante_AtacadoResult sp_Gestao_AtacadoResult = e.Row.DataItem as Sp_Nome_Representante_AtacadoResult;
