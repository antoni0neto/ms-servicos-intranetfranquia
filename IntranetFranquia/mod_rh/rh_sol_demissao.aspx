<%@ Page Title="Demissão" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="rh_sol_demissao.aspx.cs" Inherits="Relatorios.rh_sol_demissao"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <Triggers>
            <asp:PostBackTrigger ControlID="btFotoCartaIncluir" />
        </Triggers>
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo do RH&nbsp;&nbsp;>&nbsp;&nbsp;Solicitações&nbsp;&nbsp;>&nbsp;&nbsp;<asp:Label
                    ID="labTituloMenu" runat="server" Text="Demissão"></asp:Label></span>
            ...
            <div style="float: left; width: 962px; margin-left: 16%;">
                <fieldset>
                    <legend>
                        <asp:Label ID="labTitulo" runat="server" Text="Demissão"></asp:Label></legend>
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="width: 400px;">
                                <asp:DropDownList runat="server" ID="ddlFuncionario" DataValueField="CODIGO" DataTextField="NOME"
                                    Height="22px" Width="394px" OnSelectedIndexChanged="ddlFuncionario_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="labDataPedidoDemissao" runat="server" Text="Data Pedido de Demissão"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:Label ID="labDataRealDemissao" runat="server" Text="Data Real de Demissão"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtDataPedidoDemissao" runat="server" MaxLength="10" Width="230px"
                                    onkeypress="return fnValidarData(event);" CssClass="alinharDireita"></asp:TextBox>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="txtDataRealDemissao" runat="server" MaxLength="10" Width="230px"
                                    onkeypress="return fnValidarData(event);" CssClass="alinharDireita"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <fieldset style="margin-top: 4px; padding-top: 0;">
                                    <legend>
                                        <asp:Label ID="labCartaPedidoDemissao" runat="server" Text="Carta Pedido de Demissão"></asp:Label></legend>
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="width: 150px; vertical-align: top;">
                                                <asp:FileUpload ID="uploadFotoCarta" runat="server" Width="300px" /><br />
                                                <br />
                                                <br />
                                                <br />
                                                <br />
                                                <asp:Button ID="btFotoCartaIncluir" runat="server" OnClick="btFotoCartaIncluir_Click"
                                                    Text=">>" Width="32px" />
                                            </td>
                                            <td>
                                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="text-align: right;">
                                                            <asp:Image ID="imgCartaPedidoDemissao" runat="server" Width="80px" Height="100px" AlternateText="Nenhum Arquivo..." BorderWidth="1" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
