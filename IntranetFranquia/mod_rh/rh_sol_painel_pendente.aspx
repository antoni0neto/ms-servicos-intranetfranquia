<%@ Page Title="Painel de Solicitações Pendentes" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="rh_sol_painel_pendente.aspx.cs" Inherits="Relatorios.rh_sol_painel_pendente"
        ...
        <ContentTemplate>
            ...
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo do RH&nbsp;&nbsp;>&nbsp;&nbsp;Solicitações&nbsp;&nbsp;>&nbsp;&nbsp;<asp:Label
                    ID="labTituloMenu" runat="server" Text="Painel de Solicitações Pendentes"></asp:Label></span>
            ...
            <div style="float: left; width: 100%;">
                <fieldset>
                    <legend>
                        <asp:Label ID="labTitulo" runat="server" Text="Painel de Solicitações Pendentes"></asp:Label></legend>
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="width: 160px;">
                                <asp:TextBox ID="txtNumeroSolicitacao" runat="server" Width="150px" CssClass="alinharDireita" onkeypress="return fnValidarNumero(event);"></asp:TextBox>
                            </td>
