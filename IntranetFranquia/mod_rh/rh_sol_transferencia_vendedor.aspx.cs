...
{
    public partial class rh_sol_transferencia_vendedor : System.Web.UI.Page
    {
        RHController rhController = new RHController();
        BaseController baseController = new BaseController();

        const int TIPO_SOLICITACAO = 2;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                var solicitacao = rhController.ObterSolTransferencia(codigoWF);
                if (solicitacao != null)
                {
        ...
        {
            List<FILIAI> lstFilialPara = new List<FILIAI>();
            lstFilialPara = new BaseController().BuscaFiliais().Where(p => p.COD_FILIAL.Trim() != filial.Trim()).OrderBy(o => o.FILIAL).ToList();
            var filialDePara = baseController.BuscaFilialDePara();
        ...
        protected void btEnviar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var solicitacao = rhController.ObterSolTransferencia(codigoWorkFlow);
                    if (solicitacao != null)
        ...
        private int InserirSolicitacao(int codigoWorkFlow)
        {
            ...
            RH_SOL_TRANSFERENCIA solTT = null;

            if (hidCodigoWF.Value == "")
                solTT = new RH_SOL_TRANSFERENCIA();
            else
                solTT = rhController.ObterSolTransferencia(Convert.ToInt32(hidCodigoWF.Value));

            solTT.CODIGO_FILIAL_REGISTRO = ddlFilialRegistro.SelectedValue;
            ...
            if (txtSalario.Text.Trim() != "")
                solTT.SALARIO = Convert.ToDecimal(txtSalario.Text);
            solTT.PERIODO_TRABALHO = txtPeriodoTrabalho.Text.ToUpper().Trim();
            if (txtComissao.Text.Trim() != "")
                solTT.COMISSAO = Convert.ToDecimal(txtComissao.Text);
            ...
            if (hidCodigoWF.Value == "")
            {
                ...
                retorno = rhController.InserirSolTransferencia(solTT);
            }
            else
                rhController.AtualizarSolTransferencia(solTT);
        ...
        protected void btImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (hidCodigoWF.Value != "")
                {
                    var solicitacao = rhController.ObterSolTransferencia(Convert.ToInt32(hidCodigoWF.Value));
                    if (solicitacao != null)
                        GerarRelatorio(solicitacao);
                    else
        ...
        private void GerarRelatorio(RH_SOL_TRANSFERENCIA _solicitacao)
        {
            StreamWriter wr = null;
            try
            {
                string nomeArquivo = "SOLICITACAO_TV_" + ((USUARIO)Session["USUARIO"]).CODIGO_USUARIO + ".html";
        ...
        private StringBuilder MontarRelatorioHTML(RH_SOL_TRANSFERENCIA _solicitacao)
        {
        ...
        private StringBuilder MontarFormulario(RH_SOL_TRANSFERENCIA _solicitacao)
        {
            StringBuilder _texto = new StringBuilder();
            _texto.Append("");
            ...
            _texto.Append("<html>");
            _texto.Append("<head>");
            _texto.Append("    <title>Formulário Transferência de Funcionário</title>");
            ...
            _texto.Append("        <br />");
            _texto.Append("        <div id='divTransf' align='center' style='border: 1px solid #000; width: 517pt; height:960px;'>");
            ...
            _texto.Append("                <tr>");
            _texto.Append("                    <td colspan='2' style='text-align:center;'>");
            _texto.Append("                        <h2>Formulário de Transferência de Funcionário</h2>");
            _texto.Append("                    </td>");
            _texto.Append("                </tr>");
            _texto.Append("                <tr>");
            _texto.Append("                    <td colspan='2' style='line-height:60px;'>");
            ...
            _texto.Append("                                </td>");
            _texto.Append("                                <td colspan='2'>");
            _texto.Append("                                    " + baseController.BuscaFilialCodigo(Convert.ToInt32(_solicitacao.CODIGO_FILIAL_ATUAL)).FILIAL.Trim());
            _texto.Append("                                </td>");
            _texto.Append("                            </tr>");
            _texto.Append("                            <tr>");
            _texto.Append("                                <td colspan='2'>");
            ...
            _texto.Append("                            <tr>");
            _texto.Append("                                <td colspan='2'>");
            _texto.Append("                                    Para Filial:");
            _texto.Append("                                </td>");
            _texto.Append("                                <td colspan='2'>");
            _texto.Append("                                    " + baseController.BuscaFilialCodigo(Convert.ToInt32(_solicitacao.CODIGO_FILIAL_PARA)).FILIAL.Trim());
            _texto.Append("                                </td>");
            _texto.Append("                            </tr>");
            _texto.Append("                            <tr>");
            _texto.Append("                                <td colspan='2'>");
        ...
        private void EnviarEmail(int codigoWF)
        {
            ...
            email.ASSUNTO = "Intranet:  Solicitação de Transferência de Funcionário - No.: " + ("000000" + codigoWF).Substring(codigoWF.ToString().Length, 6);
        ...
        private string MontarCorpoEmail(int codigoWF)
        {
            ...
            sb.Append("<html>");
            sb.Append("<head>");
            sb.Append("    <title>Transferência de Funcionário</title>");
            ...
            sb.Append("                        <h2>Transferência de Funcionário</h2>");
            sb.Append("                    </td>");
            sb.Append("                </tr>");
            sb.Append("                <tr>");
            sb.Append("                    <td style='text-align:center;'>");
