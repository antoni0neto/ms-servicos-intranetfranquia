...
{
    public partial class RaioXGrupo : System.Web.UI.Page
    {
        ...
        {
            ddlGrupo.DataSource = baseController.BuscaGruposProduto(ddlCategoria.SelectedValue, colecao);
            ddlGrupo.DataBind();
        }
        ...
        protected void btMovimento_Click(object sender, EventArgs e)
        {
            ...
            PRODUTOS_GRUPO grupo = baseController.BuscaGrupoProduto(ddlGrupo.SelectedValue.ToString());

            if (grupo != null)
            {
                ImageProduto.ImageUrl = "~/Upload/logo.jpg";

                LiteralCodigoProduto.Text = grupo.CODIGO_GRUPO;
                LiteralDescricaoProduto.Text = grupo.GRUPO_PRODUTO;
                LiteralGrupo.Text = grupo.GRUPO_PRODUTO;
                LiteralSubGrupo.Text = grupo.GRUPO_PRODUTO;
                LiteralTipo.Text = grupo.GRUPO_PRODUTO;
                LiteralLinha.Text = grupo.GRUPO_PRODUTO;

                Sp_Preco_GrupoResult grupoPrecoTl = baseController.BuscaPrecoGrupo("TL", ddlGrupo.SelectedValue.ToString(), ddlColecao.SelectedValue);

                if (grupoPrecoTl != null)
                {
                    LiteralPrecoFinal.Text = Convert.ToDecimal(grupoPrecoTl.preco).ToString("N2");
                    LiteralPrecoAtualVarejo.Text = Convert.ToDecimal(grupoPrecoTl.preco).ToString("N2");
                }

                Sp_Preco_GrupoResult grupoPreco = baseController.BuscaPrecoGrupo("TA", ddlGrupo.SelectedValue.ToString(), ddlColecao.SelectedValue);

                if (grupoPreco != null)
                    LiteralPrecoAtacado.Text = Convert.ToDecimal(grupoPreco.preco).ToString("N2");

                grupoPreco = baseController.BuscaPrecoGrupo("TF", ddlGrupo.SelectedValue.ToString(), ddlColecao.SelectedValue);

                if (grupoPreco != null)
                    LiteralPrecoFranquia.Text = Convert.ToDecimal(grupoPreco.preco).ToString("N2");

                Sp_Busca_Vendas_Varejo_GrupoResult vendasVarejo = baseController.BuscaVendasVarejoGrupo(dataInicioFimVenda.dataInicioVenda.ToString(),
                                                                                                        dataInicioFimVenda.dataFimVenda.ToString(),
                                                                                                        ddlGrupo.SelectedValue.ToString(), 
                ...
                Sp_Busca_Vendas_Franquia_GrupoResult vendasFranquia = baseController.BuscaVendasFranquiaGrupo(dataInicioFimVenda.dataInicioVenda.ToString(),
                                                                                                              dataInicioFimVenda.dataFimVenda.ToString(),
                                                                                                              ddlGrupo.SelectedValue.ToString(),
                                                                                                              ddlCategoria.SelectedValue,
                                                                                                              ddlColecao.SelectedValue);
                ...
                Sp_Busca_Vendas_Atacado_GrupoResult vendasAtacado = baseController.BuscaVendasAtacadoGrupo(dataInicioFimVenda.dataInicioVenda.ToString(),
                                                                                                           dataInicioFimVenda.dataFimVenda.ToString(),
                                                                                                           ddlGrupo.SelectedValue.ToString(),
                                                                                                           ddlCategoria.SelectedValue,
                                                                                                           ddlColecao.SelectedValue);
                ...
                Sp_Busca_Vendas_Varejo_GrupoResult vendas;
                int? estoque;
                ...
                vendas = baseController.BuscaVendasVarejoGrupo(dataInicio, dataFim, ddlGrupo.SelectedValue.ToString(), ddlCategoria.SelectedValue, ddlColecao.SelectedValue