<%@ Page Title="Tipos de Amostra" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fre_cad_tipo_amostra.aspx.cs" Inherits="Relatorios.mod_frete.fre_cad_tipo_amostra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Frete&nbsp;&nbsp;>&nbsp;&nbsp;Cadastros&nbsp;&nbsp;>&nbsp;&nbsp;Tipos de Amostra</span>
            ...
            <div style="float: left; width: 1000px; margin-left: 15%;">
                <fieldset>
                    <legend>Cadastro de Tipos de Amostra</legend>
                    ...
                    <div style="width: 100%; overflow: auto; height: 450px;">
                        <div>
                            <div class="rounded_corners">
                                <asp:GridView ID="gvCadTipoAmostra" runat="server" Width="100%" AutoGenerateColumns="False"
