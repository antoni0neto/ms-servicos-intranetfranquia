<%@ Page Title="Tipos de Envio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fre_cad_tipo_envio.aspx.cs" Inherits="Relatorios.mod_frete.fre_cad_tipo_envio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Frete&nbsp;&nbsp;>&nbsp;&nbsp;Cadastros&nbsp;&nbsp;>&nbsp;&nbsp;Tipos de Envio</span>
            ...
            <div style="float: left; width: 1000px; margin-left: 15%;">
                <fieldset>
                    <legend>Cadastro de Tipos de Envio</legend>
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="tb">
                        ...
                        <tr>
                            <td style="width: 200px;">
                                <asp:TextBox ID="txtDescricao" runat="server" MaxLength="50" Width="190px"></asp:TextBox>
                            </td>
                    ...
                    <div style="width: 100%; overflow: auto; height: 450px;">
                        <div>
                            ...
                            <div class="rounded_corners">
                                <asp:GridView ID="gvCadTipoEnvio" runat="server" Width="100%" AutoGenerateColumns="False"
