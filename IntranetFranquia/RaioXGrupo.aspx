<%@ Page Title="Raio X de Peças por Grupo de Produto" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="RaioXGrupo.aspx.cs" Inherits="Relatorios.RaioXGrupo" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList runat="server" ID="ddlGrupo" DataValueField="GRUPO" DataTextField="GRUPO" Height="22px" 
                            Width="198px" autopostback = "true" ondatabound="ddlGrupo_DataBound"></asp:DropDownList>
                    </td>
                </tr>
            </table>
        </fieldset>
        <asp:Button runat="server" ID="btMovimento" Text="Buscar Movimento do Produto" OnClick="btMovimento_Click"/>
        <div>
            <br />
        </div>
