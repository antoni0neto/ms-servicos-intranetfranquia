<%@ Page Title="HB Baixar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="prod_cad_hb_baixa.aspx.cs" Inherits="Relatorios.prod_cad_hb_baixa"
        ...
        <ContentTemplate>
            ...
            <div class="login" style="float: left; width: 1000px; margin-left: 16%;">
                <fieldset>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="width: 160px;">
                                            ...
                                            <asp:HiddenField ID="hidGrupoTecido" runat="server" Value="" />
                                        </td>
                                        <td style="width: 80px;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='3' style="text-align: right;">Liquidar
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan='2'>
                                        ...
                                        <td style="text-align: right;">
                                            <asp:CheckBox ID="cbLiquidarPqno" runat="server" />
                                        </td>
                                                ...
                                                <div class="rounded_corners">
                                                    <asp:GridView ID="gvGradeCorteHB" runat="server" Width="100%" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Right">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="btGradeCorteHBExcluir" runat="server" Width="55px" Height="19px"
                    ...
                    <fieldset id="fsRiscoNomes" runat="server">
                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    Nome Ampliação
                            ...
                            <tr>
                                <td style="width:310px;">
                                    <asp:TextBox ID="txtNomeCADAmpliacao" runat="server" Width="300px"></asp:TextBox>
                                </td>
                                <td style="width:310px;">
                                    <asp:TextBox ID="txtNomeCADRisco" runat="server" Width="300px"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtNomeCADModelagem" runat="server" Width="320px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
