<%@ Page Title="Impressão Ficha Logística" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="prod_def_logistica_imp.aspx.cs" Inherits="Relatorios.prod_def_logistica_imp" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Produção&nbsp;&nbsp;>&nbsp;&nbsp;Logística&nbsp;&nbsp;>&nbsp;&nbsp;Impressão Ficha Logística</span>
            ...
            <div class="login">
                <fieldset style="padding-top: 0;">
                    <legend>Impressão Ficha Logística</legend>
                                    ...
                                    <asp:GridView ID="gvLogistica" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                                <ItemTemplate>
                                                    <asp:Button ID="btImprimir" runat="server" Text="Imprimir" Height="21px" Width="100px" OnClick="btImprimir_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
