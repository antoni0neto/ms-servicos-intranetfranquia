<%@ Page Title="Liberação de Etiqueta" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="prod_fila_etiqueta.aspx.cs" Inherits="Relatorios.prod_fila_etiqueta" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Produção&nbsp;&nbsp;>&nbsp;&nbsp;Custo/Preço de Produto&nbsp;&nbsp;>&nbsp;&nbsp;Liberação de Etiqueta</span>
            ...
            <div class="login">
                <fieldset style="padding-top: 0;">
                    <legend>Liberação de Etiqueta</legend>
                                                ...
                                                <td style="width: 100%;">
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvPrincipal" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            ShowFooter="true" DataKeyNames="TIPO, CODIGO, PEDIDO, PRODUTO, COR_PRODUTO, ENTREGA">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="DESC_COLECAO" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderText="Coleção" HeaderStyle-Width="160px" SortExpression="DESC_COLECAO" />
                                                ...
                                                <td style="width: 100%;">
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvMostruario" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            ShowFooter="true" DataKeyNames="TIPO, CODIGO, PEDIDO, PRODUTO, COR_PRODUTO">
                                                            <HeaderStyle BackColor="Gainsboro" HorizontalAlign="Center"></HeaderStyle>
                                                            <FooterStyle BackColor="Gainsboro" HorizontalAlign="Center" />
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="" HeaderStyle-Width="25px" ItemStyle-HorizontalAlign="Center">
