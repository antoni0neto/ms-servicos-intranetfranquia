<%@ Page Title="Risco Diário" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="prod_fila_riscado_dia.aspx.cs" Inherits="Relatorios.prod_fila_riscado_dia" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Produção&nbsp;&nbsp;>&nbsp;&nbsp;Gestão
                    de Ordem de Corte&nbsp;&nbsp;>&nbsp;&nbsp;Risco Diário</span>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td style="width: 160px;">
                                <asp:TextBox ID="txtDataPesquisa" runat="server" Width="150px" Enabled="false" onkeypress="return fnValidarData(event);"
