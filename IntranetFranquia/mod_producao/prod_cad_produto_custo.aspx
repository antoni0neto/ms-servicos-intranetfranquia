<%@ Page Title="Simulação de Custo/Preço" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="prod_cad_produto_custo.aspx.cs" Inherits="Relatorios.prod_cad_produto_custo"
                ...
                <fieldset>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <asp:Panel ID="pnlCusto" runat="server" Visible="false">
                            ...
                            <tr style="height: 10px;">
                                <td>
                                    <asp:TextBox ID="txtValorEtiqueta" runat="server" Width="170px" Text="0,26" onkeypress="return fnValidarNumeroDecimal(event);"
                                        CssClass="alinharDireita"></asp:TextBox>

                                </td>
                                <td>
                                    <asp:TextBox ID="txtValorOperacional" runat="server" Width="150px" Text="6,90" onkeypress="return fnValidarNumeroDecimal(event);"
                                        CssClass="alinharDireita"></asp:TextBox>
                                </td>
                                <td>&nbsp;
                                </td>
