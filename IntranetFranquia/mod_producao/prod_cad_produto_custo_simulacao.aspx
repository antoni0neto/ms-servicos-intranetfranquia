<%@ Page Title="Simulação sem Corte" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="prod_cad_produto_custo_simulacao.aspx.cs" Inherits="Relatorios.prod_cad_produto_custo_simulacao"
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <asp:Panel ID="pnlCusto" runat="server">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:HiddenField ID="hidICMSCredito" runat="server" Value="0" />
