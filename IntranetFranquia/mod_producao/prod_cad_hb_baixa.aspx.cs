...
{
    public partial class prod_cad_hb_baixa : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (hidTela.Value == "2") //ACESSANDO ESTA TELA DA BAIXA DO RISCO
                {
                    ...
                    fsRiscoNomes.Visible = true;
                    fsCorteBaixa.Visible = false;
                    //Carregar combo com codigo do Principal e Detalhes
                    CarregarTipoRisco();
                    ...
                    {
                        ddlRisco.SelectedValue = hidHB.Value;
                        ddlRisco.Enabled = false;
                    }

                    txtVolume.Enabled = false;
                    ddlGabarito.Enabled = false;
                ...
                if (prod_hb != null)
                {
                    ...
                    hidGrupoTecido.Value = prod_hb.GRUPO_TECIDO;
                    ...
                    txtNomeCADAmpliacao.Text = prod_hb.NOME_AMPLIACAO;
                    txtNomeCADRisco.Text = prod_hb.NOME_RISCO;
                    txtNomeCADModelagem.Text = prod_hb.NOME_MODELAGEM;
        ...
        private void MontarRiscoNome()
        {
            if (ddlRisco.SelectedValue != "")
            {
                ...
                int codigoHB = Convert.ToInt32(ddlRisco.SelectedValue);
                ...
                if (p != null)
                {
                    ...
                    txtRiscoNome.Text = txtHB.Text.Trim() + "" + hidMostruario.Value + "" + ddlColecoes.SelectedValue.Trim() + "" + riscoLetra + riscoPosicao;
                }
            }
        }
        ...
        protected void btIncluirCorte_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                codigoHB = Convert.ToInt32(ddlRisco.SelectedValue);
                ...
                var _list = new List<PROD_HB_GRADE_SUB>();
        ...
        private void BaixarRisco()
        {
            ...
            prodHb.NOME_AMPLIACAO = txtNomeCADAmpliacao.Text.Trim().ToUpper();
            prodHb.NOME_RISCO = txtNomeCADRisco.Text.Trim().ToUpper();
            prodHb.NOME_MODELAGEM = txtNomeCADModelagem.Text.Trim().ToUpper();

            AtualizarHB(prodHb);

            //Baixa primeiro processo
            AtualizarProcessoDataFim(codigoHB, ObterProcessoOrdem(2), Convert.ToDateTime(hidData.Value));
            //Iniciar segundo processo

            var processoExiste = prodController.ObterProcessoHB(codigoHB, 3);
            if (processoExiste == null)
            {
                var _processo = new PROD_HB_PROD_PROCESSO();
                _processo.PROD_HB = codigoHB;
                _processo.PROD_PROCESSO = ObterProcessoOrdem(3); //Obter o terceiro processo
                _processo.DATA_INICIO = Convert.ToDateTime(Convert.ToDateTime(hidData.Value).ToString("yyyy-MM-dd ") + DateTime.Now.ToString("HH:mm:ss"));
                IncluirProcesso(_processo);
            }

            List<PROD_HB> _detalhes = new List<PROD_HB>();
            _detalhes = prodController.ObterDetalhesHB(codigoHB);

            //Atualizar grade prevista principal
            var gradePrevista = prodController.ObterGradeHB(codigoHB, 2);
            ...
            //Atualizar grade de detalhes
            foreach (PROD_HB d in _detalhes)
            {
                if (d != null)
                {

                    var gradePrevistaDet = prodController.ObterGradeHB(d.CODIGO, 2);

                    gradePrevistaDet.GRADE_EXP = Convert.ToInt32(txtGradeEXP.Text);
                    gradePrevistaDet.GRADE_XP = Convert.ToInt32(txtGradeXP.Text);
                    gradePrevistaDet.GRADE_PP = Convert.ToInt32(txtGradePP.Text);
                    gradePrevistaDet.GRADE_P = Convert.ToInt32(txtGradeP.Text);
                    gradePrevistaDet.GRADE_M = Convert.ToInt32(txtGradeM.Text);
                    gradePrevistaDet.GRADE_G = Convert.ToInt32(txtGradeG.Text);
                    gradePrevistaDet.GRADE_GG = Convert.ToInt32(txtGradeGG.Text);

                    prodController.AtualizarGrade(gradePrevistaDet, 2);

                    if (hidMostruario.Value == "N" && (d.PROD_DETALHE != 4 && d.PROD_DETALHE != 5))
                    {
                        continue;
                    }
                    //Baixa primeiro processo
                    AtualizarProcessoDataFim(d.CODIGO, ObterProcessoOrdem(2), Convert.ToDateTime(hidData.Value));

                    var processoDetExiste = prodController.ObterProcessoHB(d.CODIGO, 3);
                    if (processoDetExiste == null)
                    {
                        //Iniciar segundo processo
                        var processoDet = new PROD_HB_PROD_PROCESSO();
                        processoDet.PROD_HB = d.CODIGO;
                        processoDet.PROD_PROCESSO = ObterProcessoOrdem(3); //Obter o terceiro processo
                        processoDet.DATA_INICIO = Convert.ToDateTime(Convert.ToDateTime(hidData.Value).ToString("yyyy-MM-dd ") + DateTime.Now.ToString("HH:mm:ss"));
                    ...
                    {
                        prodController.InserirDadosGalao(Convert.ToInt32(d.CODIGO_PAI), Convert.ToInt32(d.PROD_DETALHE));
                    }
        ...
        private bool BaixarCorte(string tela)
        {
            ...
            if (principal != null)
            {
                ...
                if (principal.STATUS != 'B')
                {
                    ...
                    _grade.PROD_PROCESSO = 3; //GRAVA GRADE
                    _grade.GRADE_EXP = (txtGradeEXP_R.Text != "") ? Convert.ToInt32(txtGradeEXP_R.Text) : 0;
                    _grade.GRADE_XP = (txtGradeXP_R.Text != "") ? Convert.ToInt32(txtGradeXP_R.Text) : 0;
                    _grade.GRADE_PP = (txtGradePP_R.Text != "") ? Convert.ToInt32(txtGradePP_R.Text) : 0;
                    _grade.GRADE_P = (txtGradeP_R.Text != "") ? Convert.ToInt32(txtGradeP_R.Text) : 0;
                ...
                if (hidMostruario.Value == "N" && principal.LIQUIDAR == 'S')
                {
                    ...
                    foreach (PROD_HB det in detalhes.Where(p => p.PROD_DETALHE != 4 && p.PROD_DETALHE != 5).ToList()) //RETIRAR GALAO
                    {
                        ...
                        _processo.PROD_HB = det.CODIGO;
                        _processo.PROD_PROCESSO = ObterProcessoOrdem(2); //Obter o primeiro processo
                    ...
                    lstBaixaDetalhe.Add(prodController.ObterDetalhesHB(Convert.ToInt32(hidHB.Value), 4)); //Galao
                    lstBaixaDetalhe.Add(prodController.ObterDetalhesHB(Convert.ToInt32(hidHB.Value), 5)); //Galao Proprio
                    foreach (PROD_HB d in lstBaixaDetalhe)
                    {
                        if (d != null)
                        {
                            //Inserir grade
                            ...
                            _grade.PROD_PROCESSO = 3; //GRADE DO RISCO
                            _grade.GRADE_EXP = (txtGradeEXP_R.Text != "") ? Convert.ToInt32(txtGradeEXP_R.Text) : 0;
                            _grade.GRADE_XP = (txtGradeXP_R.Text != "") ? Convert.ToInt32(txtGradeXP_R.Text) : 0;
                            _grade.GRADE_PP = (txtGradePP_R.Text != "") ? Convert.ToInt32(txtGradePP_R.Text) : 0;
                            _grade.GRADE_P = (txtGradeP_R.Text != "") ? Convert.ToInt32(txtGradeP_R.Text) : 0;
                            ...
                            if (d.PROD_DETALHE == 4)
                            {
                                ...
                                _prod_hb.CODIGO = d.CODIGO;
                                _prod_hb.UNIDADE_MEDIDA = Convert.ToInt32(ddlUnidadeGalao.SelectedValue);
                                _prod_hb.GASTO_FOLHA = Convert.ToDecimal(txtGastoPorFolhaGalao.Text) * 1; //Convert.ToDecimal(1.07);
                                if (txtGastoPorPecaGalaoCusto.Text.Trim() != "")
                                    _prod_hb.GASTO_PECA_CUSTO = Convert.ToDecimal(txtGastoPorPecaGalaoCusto.Text);
                                _prod_hb.RETALHOS = Convert.ToDecimal(txtGastoRetalhosGalao.Text);
                                _prod_hb.STATUS = 'B'; //BAIXADO

                                AtualizarBaixaHB(_prod_hb);

                                //Baixa primeiro processo
                                AtualizarProcessoDataFim(d.CODIGO, ObterProcessoOrdem(3), Convert.ToDateTime(hidData.Value));

                                d.UNIDADE_MEDIDA = _prod_hb.UNIDADE_MEDIDA;
                                d.GASTO_FOLHA = _prod_hb.GASTO_FOLHA;
                                d.GASTO_PECA_CUSTO = _prod_hb.GASTO_PECA_CUSTO;
                                d.RETALHOS = _prod_hb.RETALHOS;
                                d.CODIGO_PRODUTO_LINX = principal.CODIGO_PRODUTO_LINX;
                                CriarFichaTecnica(produtoPrincipal, d);
                            }
                            ...
                            if (d.PROD_DETALHE == 5)
                            {
                                var _prod_hb = new PROD_HB();
                                _prod_hb.CODIGO = d.CODIGO;
                                _prod_hb.UNIDADE_MEDIDA = Convert.ToInt32(ddlUnidadeGalaoProprio.SelectedValue);
                                _prod_hb.GASTO_FOLHA = Convert.ToDecimal(txtGastoPorFolhaGalaoProprio.Text) * 1; // Convert.ToDecimal(1.07);
                                if (txtGastoPorPecaGalaoCustoProprio.Text.Trim() != "")
                                    _prod_hb.GASTO_PECA_CUSTO = Convert.ToDecimal(txtGastoPorPecaGalaoCustoProprio.Text);
                                _prod_hb.RETALHOS = Convert.ToDecimal(txtGastoRetalhosGalaoProprio.Text);
                                _prod_hb.STATUS = 'B'; //BAIXADO
                ...
                else // É mostruário ou corte sem liquidar
                {
                    int codigoHB = 0;
        ...
        private void PreencherDadosMostruarioBaixa(PROD_HB principal)
        {
            ...
            foreach (GridViewRow row in gvDetalhe.Rows)
            {
                ...
                if (det != null)
                {
                    ...
                    _ddlUnidadeMedida.Enabled = false;
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //PARA REENVIO DE EMAIL COLOCAR O CODIGO DO HB
                //PROD_HB prod_hb = prodController.ObterHB(35823);
                //EnviarEmail(prod_hb);
                ...
                else
                {
                    ...
                    if (prod_hb.MOSTRUARIO == 'S' || (prod_hb.MOSTRUARIO == 'N' && (_detalhes == null || _detalhes.Where(p => p.PROD_DETALHE != 4 && p.PROD_DETALHE != 5).Count() <= 0)))
                    {
                        ...
                        if (prod_hb.NUMERO_PEDIDO != 2028)
                        {
                            ...
                            if (validaSaida == null || validaSaida.Count() <= 0)
                            {
                                ...
                                _saida.GRADE_EXP = (txtGradeEXP_R.Text != "") ? Convert.ToInt32(txtGradeEXP_R.Text) : 0;
                                _saida.GRADE_XP = (txtGradeXP_R.Text != "") ? Convert.ToInt32(txtGradeXP_R.Text) : 0;
                                _saida.GRADE_PP = (txtGradePP_R.Text != "") ? Convert.ToInt32(txtGradePP_R.Text) : 0;
                                _saida.GRADE_P = (txtGradeP_R.Text != "") ? Convert.ToInt32(txtGradeP_R.Text) : 0;
                                _saida.GRADE_M = (txtGradeM_R.Text != "") ? Convert.ToInt32(txtGradeM_R.Text) : 0;
                                _saida.GRADE_G = (txtGradeG_R.Text != "") ? Convert.ToInt32(txtGradeG_R.Text) : 0;
                                _saida.GRADE_GG = (txtGradeGG_R.Text != "") ? Convert.ToInt32(txtGradeGG_R.Text) : 0;
                ...
                _relatorio.GRUPO_TECIDO = hidGrupoTecido.Value.Trim().ToUpper();
                ...
                _relatorio.NOME_AMPLIACAO = txtNomeCADAmpliacao.Text.Trim().ToUpper();
                _relatorio.NOME_RISCO = txtNomeCADRisco.Text.Trim().ToUpper();
                _relatorio.NOME_MODELAGEM = txtNomeCADModelagem.Text.Trim().ToUpper();
                ...
                if (hidTela.Value == "2")
                {
                    _relatorio.GRADE = prodController.ObterGradeHB(Convert.ToInt32(hidHB.Value), 2); //GERAR RELATORIO COM A GRADE FINAL DO RISCO
                    GerarRelatorio(_relatorio, 2, bMostruario);
                    litConteudoDiv.Text = "ENVIADO PARA O CORTE";
                }
                else
                {
