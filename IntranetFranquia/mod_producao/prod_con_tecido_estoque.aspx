<%@ Page Title="Estoque (Cartelinha)" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"
    CodeBehind="prod_con_tecido_estoque.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="Relatorios.prod_con_tecido_estoque" %>
            ...
            <div style="width: 100%;">
                <fieldset>
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="0" class="bodyMaterial">
                        ...
                        <tr>
                            <td colspan="6">Descrição
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                <asp:TextBox ID="txtDescricaoMaterial" runat="server" Text="" Width="370px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <br />
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: -12px;">
                                        <tr>
                                            <td>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td colspan="6">Quantidade Estoque
                                                        </td>
                                                        <td style="text-align: right;">Estoque Conferido
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                        ...
                                                        <td style="text-align: right;">
                                                            <asp:CheckBox ID="cbEstConferido" runat="server" Checked="false" OnCheckedChanged="cbEstConferido_CheckedChanged" AutoPostBack="true" />
                                                            <asp:TextBox ID="txtDataEstConferido" runat="server" Text="" Width="130px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="labProduto" runat="server" Text="Produto/Pedido"></asp:Label>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 160px;">
                                                            <asp:TextBox ID="txtFolhas" runat="server" CssClass="alinharDireita" Text="" Width="150px"
                                                                onkeypress="return fnValidarNumeroDecimalNegativo(event);" OnTextChanged="CalcularSobraEstoque" AutoPostBack="true"></asp:TextBox>
                                                        </td>
                                                        <td style="width: 160px;">
                                                        ...
                                                        <td style="width: 161px;">
                                                            <asp:TextBox ID="txtEstoque" runat="server" CssClass="alinharDireita" Text="" Width="150px"
                                                                onkeypress="return fnValidarNumeroDecimalNegativo(event);" Enabled="false"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                ...
                                                <div class="rounded_corners">
                                                    <asp:GridView ID="gvHB" runat="server" Width="100%" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Produto/Pedido" HeaderStyle-Width="105px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                            ...
                                                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="25px"
                                                                FooterStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="btMarcarSimulado" runat="server" Height="14px" Width="14px" ImageUrl="~/Image/down.png"
                                                                        OnClick="btMarcarSimulado_Click" ToolTip="Marcar corte simulado" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="25px"
                                                                FooterStyle-HorizontalAlign="Center">
