<%@ Page Title="Desp Administrativas - Utilidades" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="adm_utilidades.aspx.cs" Inherits="Relatorios.adm_utilidades"
        ...
        <ContentTemplate>
            ...
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo Acompanhamento Mensal&nbsp;&nbsp;>&nbsp;&nbsp;Despesas
                    Administrativas&nbsp;&nbsp;>&nbsp;&nbsp;Utilidades&nbsp;&nbsp;</span>
                            ...
                            <td style="padding: 0;" colspan="3">
                                <fieldset>
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="gvUtilidade" runat="server" Width="100%" AutoGenerateColumns="False"
                                            CellPadding="0" CellSpacing="5" ForeColor="#333333" Style="background: white"
                                            BackColor="GradientActiveCaption" BorderColor="GradientActiveCaption" OnRowDataBound="gvUtilidade_RowDataBound"
                                            OnDataBound="gvUtilidade_DataBound">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="" ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Panel ID="pnlUtilidadeItem" runat="server" Style="display: none" Width="100%">
                                                            <asp:GridView ID="gvUtilidadeItem" runat="server" CellPadding="0" CellSpacing="0"
                                                                AutoGenerateColumns="false" OnDataBound="gvUtilidadeItem_DataBound" OnRowDataBound="gvUtilidadeItem_RowDataBound"
                                                                Width="100%">
                                                ...
                                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Literal ID="litUtilidade" runat="server"></asp:Literal>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
