<%@ Page Title="Faturamento Atacado" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="fat_atacado.aspx.cs" Inherits="Relatorios.fat_atacado"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo Acompanhamento Mensal&nbsp;&nbsp;>&nbsp;&nbsp;Faturamento&nbsp;&nbsp;>&nbsp;&nbsp;Atacado&nbsp;&nbsp;</span>
                            ...
                            <td style="padding: 0;" colspan="2">
                                <fieldset>
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="gvAtacado" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ShowFooter="true" ForeColor="#333333" Style="background: white" OnRowDataBound="gvAtacado_RowDataBound"
                                            OnDataBound="gvAtacado_DataBound">
                                            <HeaderStyle BackColor="GradientActiveCaption" Font-Size="Small" HorizontalAlign="Center">
                                            </HeaderStyle>
