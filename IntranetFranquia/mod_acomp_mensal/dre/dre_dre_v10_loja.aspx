<%@ Page Title="DRE Lojas" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="dre_dre_v10_loja.aspx.cs" Inherits="Relatorios.dre_dre_v10_loja" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <div>
        <span style="font-family: Calibri; font-size: 14px;">Módulo Acompanhamento Mensal&nbsp;&nbsp;>&nbsp;&nbsp;DRE&nbsp;&nbsp;>&nbsp;&nbsp;DRE Lojas&nbsp;&nbsp;</span>
                ...
                <tr>
                    ...
                    <td style="width: 150px;">
                        <asp:DropDownList runat="server" ID="ddlUnidadeNegocio" Height="22px" Width="144px" Enabled="false" OnSelectedIndexChanged="ddlUnidadeNegocio_SelectedIndexChanged" AutoPostBack="true">
                            ...
                            <asp:ListItem Value="LOJA" Text="LOJAS" Selected="True"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td style="width: 300px;">
                        <asp:DropDownList runat="server" ID="ddlFilial" DataValueField="CODIGO_FILIAL" DataTextField="FILIAL" Enabled="true"
