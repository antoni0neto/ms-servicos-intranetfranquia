<%@ Page Title="DRE - Conta Contábil" Language="C#" AutoEventWireup="true" CodeBehind="dre_dre_conta_contabil.aspx.cs"
    Inherits="Relatorios.dre_dre_conta_contabil" %>
                        ...
                        <fieldset>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <asp:HiddenField ID="hidContaContabil" runat="server" />
                                        ...
                                        <asp:HiddenField ID="hidCentroCusto" runat="server" />
                                    </td>
                                </tr>
                                <tr>
