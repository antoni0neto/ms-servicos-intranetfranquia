<%@ Page Title="DRE Comparativo" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="dre_dre_compara.aspx.cs" Inherits="Relatorios.dre_dre_compara" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo Acompanhamento Mensal&nbsp;&nbsp;>&nbsp;&nbsp;DRE&nbsp;&nbsp;>&nbsp;&nbsp;DRE Comparativo&nbsp;&nbsp;</span>
                ...
                <fieldset>
                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="width: 150px;">
                                <asp:DropDownList runat="server" ID="ddlMesDe" Height="24px" Width="144px">
                            ...
                            <td style="width: 150px;">
                                <asp:DropDownList runat="server" ID="ddlMesAte" Height="24px" Width="144px">
                                    <asp:ListItem Value="" Text=""></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Janeiro"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="Fevereiro"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="Março"></asp:ListItem>
                                    ...
                                    <div class="rounded_corners">
                                        ...
                                        <asp:GridView ID="gvReceitaLiquida" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                                            ...
                                                                            <asp:Panel ID="pnlSubGrid" runat="server" Style="display: none" Width="100%" BorderColor="Red">
                                                                                <asp:GridView ID="gvSubGrid" runat="server" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="AnoAnt2" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                                                            ItemStyle-BorderWidth="1" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoAnt2" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="AnoAnt1" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                                                            ItemStyle-BorderWidth="1">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoAnt1" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="AnoOrc" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                                                            ItemStyle-BorderWidth="1">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoOrc" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="AnoReal" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                                                            ItemStyle-BorderWidth="1">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoReal" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>

                                                                                        <asp:TemplateField HeaderText="Atingido (%)" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="190px"
                                                                                            ItemStyle-BorderWidth="1" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoAnt2Porc" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Atingido (%)" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="190px"
                                                                                            ItemStyle-BorderWidth="1">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoAnt1Porc" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>

                                                                                        <asp:TemplateField HeaderText="Atingido (%)" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                                                            ItemStyle-BorderWidth="1">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoOrcPorc" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>

                                                                                        <asp:TemplateField HeaderText="Atingido (R$)" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="190px"
                                                                                            ItemStyle-BorderWidth="1" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAtingidoValor" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                                </asp:GridView>
                                                ...
                                                <asp:TemplateField HeaderText="AnoAnt" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                    ItemStyle-BorderWidth="0" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Literal ID="litAnoAnt2" runat="server"></asp:Literal>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                                            ...
                                                                            <asp:Panel ID="pnlCMVItemSub" runat="server" Style="display: none" Width="100%" BorderColor="Red">
                                                                                <asp:GridView ID="gvCMVItemSub" runat="server" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="190px"
                                                                                            ItemStyle-BorderWidth="1" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoAnt2Porc" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="150px"
                                                                                            ItemStyle-BorderWidth="1">
                                                                                            <ItemTemplate>
                                                                                                <asp:Literal ID="litAnoOrcPorc" runat="server"></asp:Literal>
                                                                                            </ItemTemplate>
                                        ...
                                        <% //FIM DESPESAS LOJAS - ESPECIFICAS %>
                                        <% //DESPESAS VENDAS %>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="" ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Image ID="imgExpand" alt="" Style="cursor: pointer" src="../../Image/plus.png"
                                                            Width="18px" runat="server" />
                                                        <asp:Panel ID="pnlDespLojaItem" runat="server" Style="display: none" Width="100%">
