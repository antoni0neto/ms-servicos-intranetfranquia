<%@ Page Title="DRE - Conta Contábil" Language="C#" AutoEventWireup="true" CodeBehind="dre_dre_v10_conta_contabil_loja.aspx.cs"
    Inherits="Relatorios.dre_dre_v10_conta_contabil_loja" %>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 350px;">
                                        <asp:TextBox ID="txtCentroCusto" runat="server" Width="340px" ReadOnly="true" Text=""></asp:TextBox>
                                    </td>
                                    <td style="width: 450px;">
                                        <asp:TextBox ID="txtContaContabil" runat="server" Width="440px" ReadOnly="true" Text=""></asp:TextBox>
                                    </td>
                                    <td style="width: 160px;">
                                        <asp:TextBox ID="txtValorRateio" runat="server" Width="150px" CssClass="alinharDireita" ReadOnly="true" Text=""></asp:TextBox>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <asp:HiddenField ID="hidRateio" runat="server" />
                                        <asp:HiddenField ID="hidRateioVal" runat="server" />
                                    </td>
                                </tr>
                                <tr>
