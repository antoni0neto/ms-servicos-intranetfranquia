<%@ Page Title="Produto - Grade" Language="C#" AutoEventWireup="true" CodeBehind="pacab_pedido_produto_gradev2.aspx.cs"
    Inherits="Relatorios.pacab_pedido_produto_gradev2" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Produto - Grade</span>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 110px;">
                                        <asp:TextBox ID="txtProduto" runat="server" Width="100px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td style="width: 220px;">
                                        <asp:TextBox ID="txtNome" runat="server" Width="210px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td style="width: 160px;">
                                        <asp:TextBox ID="txtCor" runat="server" Width="150px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td style="width: 170px;">
                                        <asp:TextBox ID="txtGriffe" runat="server" Width="160px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td style="width: 100px;">
                                        <asp:TextBox ID="txtQtdeAtacado" runat="server" Width="90px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtQtdeVarejo" runat="server" Width="90px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="8">
