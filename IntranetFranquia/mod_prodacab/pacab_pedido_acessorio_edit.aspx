<%@ Page Title="Gerar Pedido Acessório" Language="C#" AutoEventWireup="true" CodeBehind="pacab_pedido_acessorio_edit.aspx.cs"
    Inherits="Relatorios.pacab_pedido_acessorio_edit" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Acessórios&nbsp;&nbsp;>&nbsp;&nbsp;Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Gerar Pedido</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Pedido Acessório</legend>
