<%@ Page Title="Acessório - Grade" Language="C#" AutoEventWireup="true" CodeBehind="pacab_pedido_acessorio_grade_linx.aspx.cs"
    Inherits="Relatorios.pacab_pedido_acessorio_grade_linx" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Acessórios&nbsp;&nbsp;>&nbsp;&nbsp;Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Produto - Grade Linx</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Acessório - Grade Linx</legend>
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <asp:TextBox ID="txtNotaFiscal" runat="server" Width="210px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="7">
                                        <fieldset>
                                            ...
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtGradeTotal" runat="server" MaxLength="6" CssClass="alinharCentro" Enabled="false" onkeypress="return fnValidarNumero(event);" Width="118px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
