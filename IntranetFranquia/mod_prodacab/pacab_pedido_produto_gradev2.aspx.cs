...
{
    public partial class pacab_pedido_produto_gradev2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DESENV_PRODUTO_CARRINHOV2 carrinho = desenvController.ObterCarrinhoProduto(codigoCarrinho);
                if (carrinho == null)
                    Response.Redirect("pacab_menu.aspx");

                hidCodigoCarrinho.Value = carrinho.CODIGO.ToString();

                var desenvProduto = desenvController.ObterProduto(carrinho.DESENV_PRODUTO);
                ...
                txtCusto.Text = (desenvProduto.CUSTO == null) ? "" : desenvProduto.CUSTO.ToString();
                ...
                {
                    var produto = baseController.BuscaProduto(desenvProduto.MODELO);
                    if (produto.GRADE.Trim() == "UNICO")
                    {
                        txtGrade1.Text = desenvProduto.QTDE.ToString();
                        txtGradeTotal.Text = desenvProduto.QTDE.ToString();
                    }
                }
        ...
        private void CarregarGrade(DESENV_PRODUTO_CARRINHOV2 carrinho)
        {
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var carrinho = desenvController.ObterCarrinhoProduto(Convert.ToInt32(hidCodigoCarrinho.Value));

                var desenvProduto = desenvController.ObterProduto(carrinho.DESENV_PRODUTO);
                if (desenvProduto != null)
                {
                    desenvProduto.CUSTO = Convert.ToDecimal(txtCusto.Text.Trim());
