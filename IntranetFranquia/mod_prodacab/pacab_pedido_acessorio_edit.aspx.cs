...
{
    public partial class pacab_pedido_acessorio_edit : System.Web.UI.Page
    {
        ...
        {
            var carrinho = desenvController.ObterCarrinhoAcessorioPorUsuario(((USUARIO)Session["USUARIO"]).CODIGO_USUARIO).Where(p => p.GRADE_TOTAL <= 0);
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var pedidoCompra = desenvController.GerarINTRAPrePedidoCompraAcessorio(fornecedor, limiteEntrega, filial, codigoFilialRateio, status, aprovadoPor, usuario.CODIGO_USUARIO);
        ...
        private void EnviarEmail(string pedidoIntra)
        {
            ...
            try
            {
                ...
                string assunto = "";
                assunto = "Intranet: Pedido de Acessório: " + pedidoIntra.Trim() + " - " + DateTime.Today.ToString("dd/MM/yyyy");
        ...
        private StringBuilder MontarRelatorioHTML(string pedidoIntra)
        {
            ...
            _texto = MontarCabecalho(_texto, "Pedido de Compra - Acessórios");
