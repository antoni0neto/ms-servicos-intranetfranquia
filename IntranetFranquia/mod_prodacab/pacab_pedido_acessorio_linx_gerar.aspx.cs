...
{
    public partial class pacab_pedido_acessorio_linx_gerar : System.Web.UI.Page
    {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.DataItem != null)
                {
                    ...
                    if (carrinho != null)
                    {
                        ...
                        litCustoNota.Text = (acessorio.CUSTO_NOTA == null) ? "" : ("R$ " + acessorio.CUSTO_NOTA.ToString());
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var pedidoCompra = desenvController.GerarLINXPedidoCompraAcessorioPorPrePedido(fornecedor, filial, codigoFilialRateio, 'A', aprovadoPor, usuario.CODIGO_USUARIO);
