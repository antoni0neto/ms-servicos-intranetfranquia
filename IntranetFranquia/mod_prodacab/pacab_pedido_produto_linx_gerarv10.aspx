<%@ Page Title="Pedido Linx" Language="C#" AutoEventWireup="true" CodeBehind="pacab_pedido_produto_linx_gerarv10.aspx.cs"
    Inherits="Relatorios.pacab_pedido_produto_linx_gerarv10" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Produto&nbsp;&nbsp;>&nbsp;&nbsp;Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Pedido Linx</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Linx - Pedido Produto</legend>
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td colspan="2" style="text-align: right;">
                                        <asp:Button ID="btSalvar" runat="server" Width="150px" Text="Gerar Pedido Linx" Enabled="true" OnClientClick="DesabilitarBotao(this);" OnClick="btSalvar_Click" />&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">&nbsp;</td>
