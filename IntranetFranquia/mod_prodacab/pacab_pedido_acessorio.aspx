<%@ Page Title="Pedido Acessórios" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="pacab_pedido_acessorio.aspx.cs" Inherits="Relatorios.pacab_pedido_acessorio" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Acessórios&nbsp;&nbsp;>&nbsp;&nbsp;Pedido de Acessório</span>
                                        ...
                                        <asp:GridView ID="gvCarrinho" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                                    HeaderText="Itens" HeaderStyle-Width="120px" ItemStyle-Font-Size="Smaller">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:CheckBox ID="cbAviamento" runat="server" Checked="false" Text="Aviamentos" OnCheckedChanged="cbItens_CheckedChanged" AutoPostBack="true" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
