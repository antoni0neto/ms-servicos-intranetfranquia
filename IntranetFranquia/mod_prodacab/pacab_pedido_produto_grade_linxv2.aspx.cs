...
{
    public partial class pacab_pedido_produto_grade_linxv2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DESENV_PRODUTO_CARRINHO_LINX carrinho = desenvController.ObterCarrinhoLinxProduto(codigoCarrinho);
                if (carrinho == null)
                    Response.Redirect("pacab_menu.aspx");

                hidCodigoCarrinho.Value = carrinho.CODIGO.ToString();

                var desenvProduto = desenvController.ObterProdutoCor(carrinho.PRODUTO, carrinho.COR_PRODUTO).LastOrDefault();

                txtColecao.Text = baseController.BuscaColecaoAtual(desenvProduto.COLECAO).DESC_COLECAO.Trim();
                ...
                txtCustoNota.Text = (desenvProduto.CUSTO_NOTA == null) ? "" : desenvProduto.CUSTO_NOTA.ToString();

                CarregarControleGrade(baseController.ObterProdutoTamanho(desenvProduto.MODELO));
        ...
        private void CarregarGrade(DESENV_PRODUTO_CARRINHO_LINX carrinho)
        {
        ...
        protected void btSalvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var carrinho = desenvController.ObterCarrinhoLinxProduto(Convert.ToInt32(hidCodigoCarrinho.Value));
                ...
                var desenvProdutos = desenvController.ObterProdutoPorProduto(carrinho.PRODUTO);
                foreach (var des in desenvProdutos)
                {
                    var d = desenvController.ObterProduto(des.CODIGO);
                    ...
                    desenvController.AtualizarProduto(d);
                }
        ...
        private void GerarOutroPedido(COMPRAS_PRODUTO_PREPEDIDO compraProduto)
        {
            ...
            compraProdutoDiff.COLECAO = compraProduto.COLECAO;
            compraProdutoDiff.DESENV_PRODUTO_ORIGEM = compraProduto.DESENV_PRODUTO_ORIGEM;
