<%@ Page Title="Gerar Pedido LINX Produto" Language="C#" AutoEventWireup="true" CodeBehind="pacab_pedido_produto_linx_gerarv2.aspx.cs"
    Inherits="Relatorios.pacab_pedido_produto_linx_gerarv2" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Produto Acabado&nbsp;&nbsp;>&nbsp;&nbsp;Produto&nbsp;&nbsp;>&nbsp;&nbsp;Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Gerar Pedido Linx</span>
