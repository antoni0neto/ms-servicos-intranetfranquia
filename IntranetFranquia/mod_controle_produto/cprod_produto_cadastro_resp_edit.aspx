<%@ Page Title="Enviar Etiqueta de Composição" Language="C#" AutoEventWireup="true" CodeBehind="cprod_produto_cadastro_resp_edit.aspx.cs"
    Inherits="Relatorios.cprod_produto_cadastro_resp_edit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Enviar Etiqueta de Composição</title>
    <style type="text/css">
        .fs {
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo de Controle de Produto&nbsp;&nbsp;>&nbsp;&nbsp;Etiquetas&nbsp;&nbsp;>&nbsp;&nbsp;Etiqueta de Composição&nbsp;&nbsp;>&nbsp;&nbsp;Enviar Etiqueta de Composição</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Enviar Etiqueta de Composição</legend>
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="labKids" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">&nbsp;
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList ID="ddlNCM" runat="server" Width="174px" Height="21px"
                                            DataTextField="CLASSIF_FISCAL" DataValueField="CLASSIF_FISCAL">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtNCM" runat="server" Width="300px" MaxLength="8" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                                ...
                                                <div class="rounded_corners">
                                                    <asp:GridView ID="gvComposicao" runat="server" Width="100%" AutoGenerateColumns="False" ForeColor="#333333"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="cbMarcarComp" runat="server" Checked="true" Visible="false" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
