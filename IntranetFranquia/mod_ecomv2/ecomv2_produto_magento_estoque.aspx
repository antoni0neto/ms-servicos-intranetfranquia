<%@ Page Title="Estoque Ecommerce" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"
    CodeBehind="ecomv2_produto_magento_estoque.aspx.cs" Inherits="Relatorios.ecomv2_produto_magento_estoque" %>
        ...
        <fieldset style="padding-top: 0;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td style="width: 160px">
                        <asp:DropDownList ID="ddlEstoqueLinx" runat="server" Width="154px" Height="21px">
                    ...
                    <td style="width: 160px">
                        <asp:DropDownList ID="ddlEstoqueMag" runat="server" Width="154px" Height="21px">
                            <asp:ListItem Value="" Text=""></asp:ListItem>
                            <asp:ListItem Value="S" Text="Sim"></asp:ListItem>
                            <asp:ListItem Value="N" Text="Não"></asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlHabilitado" runat="server" Width="154px" Height="21px">
                            <asp:ListItem Value="" Text=""></asp:ListItem>
                            <asp:ListItem Value="S" Text="Sim"></asp:ListItem>
                            <asp:ListItem Value="N" Text="Não"></asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    <td>
                        <asp:DropDownList ID="ddlEstoqueDiff" runat="server" Width="214px" Height="21px">
                            <asp:ListItem Value="" Text=""></asp:ListItem>
                            <asp:ListItem Value="S" Text="Sim"></asp:ListItem>
                            <asp:ListItem Value="N" Text="Não"></asp:ListItem>
                        </asp:DropDownList></td>
