<%@ Page Title="Relacionados - Criar Produto Relacionado" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecomv2_rel_config_rel_criar_random.aspx.cs" Inherits="Relatorios.ecomv2_rel_config_rel_criar_random" %>
                        ...
                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="width: 170px;">
                                    <asp:TextBox ID="txtProduto" runat="server" Width="156px" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 210px;">
                                    <asp:TextBox ID="txtNome" runat="server" Width="196px" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 180px;">
                                    <asp:TextBox ID="txtSKU" runat="server" Width="166px" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 200px;">
                                    <asp:TextBox ID="txtCor" runat="server" Width="186px" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 190px;">
                                    <asp:TextBox ID="txtGrupoProduto" runat="server" Width="176px" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 190px;">
                                    <asp:TextBox ID="txtGriffe" runat="server" Width="176px" Enabled="false"></asp:TextBox>
                                </td>
                                <td style="width: 126px;">
                                    <asp:Button ID="btCriarRegra" runat="server" Width="116px" Text="Criar Regra" OnClick="btCriarRegra_Click" />
                                </td>
                                <td>
                                    <asp:Button ID="btRelacionarRegra" runat="server" Width="130px" Text="Relacionar Regra" OnClick="btRelacionarRegra_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="8">
                            ...
                            <tr>
                                <td colspan="8">
                                    <fieldset>
                                        <legend>Produtos Que Voce Pode Gostar</legend>
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <asp:HiddenField ID="hidUpSell3" runat="server" Value="" />
                                                    SKU
                                                    <br />
                                                    <asp:TextBox ID="txtUpsell3" runat="server" Text="" Width="150px" MaxLength="12" CssClass="aligncenter" OnTextChanged="txtUpsell3_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    <br />
                                                    <asp:CheckBox ID="cbUpSell3" runat="server" Checked="false" OnCheckedChanged="cbUpSell3_CheckedChanged" AutoPostBack="true" />
                                                    <br />
                                                    <asp:Image ID="imgUpSell3" runat="server" Width="156px" Height="228px" AlternateText="Nenhuma Foto" BorderWidth="0" />
                                                    <br />
                                                    Já foi relacionado
                                                    <asp:Label ID="labTotRelUp3" runat="server" Font-Bold="true"></asp:Label>
                                                    vez(es)
                                                </td>
                                                <td style="text-align: center;">
                                                    <asp:HiddenField ID="hidUpSell4" runat="server" Value="" />
                                                    SKU
                                                    <br />
                                                    <asp:TextBox ID="txtUpsell4" runat="server" Text="" Width="150px" MaxLength="12" CssClass="aligncenter" OnTextChanged="txtUpsell4_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    <br />
                                                    <asp:CheckBox ID="cbUpSell4" runat="server" Checked="false" OnCheckedChanged="cbUpSell4_CheckedChanged" AutoPostBack="true" />
                                                    <br />
                                                    <asp:Image ID="imgUpSell4" runat="server" Width="156px" Height="228px" AlternateText="Nenhuma Foto" BorderWidth="0" />
                                                    <br />
                                                    Já foi relacionado
                                                    <asp:Label ID="labTotRelUp4" runat="server" Font-Bold="true"></asp:Label>
                                                    vez(es)
                                                </td>
                                            </tr>
                                        </table>
