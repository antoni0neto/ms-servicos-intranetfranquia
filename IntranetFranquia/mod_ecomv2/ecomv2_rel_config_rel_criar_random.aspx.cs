...
{
    public partial class ecomv2_rel_config_rel_criar_random : System.Web.UI.Page
    {
        ...
        private void PreencherFotosRelOK(List<ECOM_PRODUTO_RELACIONADO> produtoRelOK)
        {
            ...
            foreach (var pr in produtoRelOK)
            {
                ...
                else if (i == 3 && pr.PRIORIDADE == 2)
                    imgUpSell3.ImageUrl = eController.ObterMagentoProduto(pr.ECOM_PRODUTO_REL).FOTO_FRENTE_CAB;
                else if (i == 4 && pr.PRIORIDADE == 2)
                    imgUpSell4.ImageUrl = eController.ObterMagentoProduto(pr.ECOM_PRODUTO_REL).FOTO_FRENTE_CAB;
                else if (i == 5)
        ...
        private string AtualizarProdutosRandom(string produto, string cor)
        {
            ...
            if (produtoRel == null || produtoRel.Count() <= 0)
                return "Não foi encontrado nenhuma REGRA DE SAÍDA. Crie ou Altere as regras de Saída para o GRUPO " + txtGrupoProduto.Text.Trim();

            if (produtoRel.Count() < 8)
            ...
            {
                if (hidUpSell1.Value == "" && (pr.PRIORIDADE == 1 || pr.PRIORIDADE == 2) && pr.TIPO == "upsell" && (pr.POSICAO == 1 || pr.POSICAO == 0))
                {
                ...
                else if (hidUpSell2.Value == "" && pr.PRIORIDADE == 2 && pr.TIPO == "upsell" && (pr.POSICAO == 2 || pr.POSICAO == 0))
                {
                ...
                else if (hidUpSell3.Value == "" && pr.PRIORIDADE == 2 && pr.TIPO == "upsell" && (pr.POSICAO == 3 || pr.POSICAO == 0))
                {
                    imgUpSell3.ImageUrl = pr.FOTO_FRENTE_CAB;
                    labTotRelUp3.Text = pr.TOT_REL.ToString();
                    hidUpSell3.Value = pr.CODIGO.ToString();
                    txtUpsell3.Text = pr.SKU_MANUAL;
                    cbUpSell3.Checked = (pr.FIXO == "N") ? false : true;
                    if (cbUpSell3.Checked && txtUpsell3.Text == "")
                        txtUpsell3.Enabled = false;

                    if (cbUpSell3.Checked && txtUpsell3.Text != "")
                        cbUpSell3.Enabled = false;
                }
                else if (hidUpSell4.Value == "" && pr.PRIORIDADE == 2 && pr.TIPO == "upsell" && (pr.POSICAO == 4 || pr.POSICAO == 0))
                {
                    imgUpSell4.ImageUrl = pr.FOTO_FRENTE_CAB;
                    labTotRelUp4.Text = pr.TOT_REL.ToString();
                    hidUpSell4.Value = pr.CODIGO.ToString();
                    txtUpsell4.Text = pr.SKU_MANUAL;
                    cbUpSell4.Checked = (pr.FIXO == "N") ? false : true;
                    if (cbUpSell4.Checked && txtUpsell4.Text == "")
                        txtUpsell4.Enabled = false;

                    if (cbUpSell4.Checked && txtUpsell4.Text != "")
                        cbUpSell4.Enabled = false;
                }
                else if (hidRelated1.Value == "" && pr.PRIORIDADE == 99 && pr.TIPO == "related" && (pr.POSICAO == 5 || pr.POSICAO == 0))
                {
                ...
                else if (hidRelated2.Value == "" && pr.PRIORIDADE == 99 && pr.TIPO == "related" && (pr.POSICAO == 6 || pr.POSICAO == 0))
                {
                ...
                else if (hidRelated3.Value == "" && pr.PRIORIDADE == 99 && pr.TIPO == "related" && (pr.POSICAO == 7 || pr.POSICAO == 0))
                {
                ...
                else if (hidRelated4.Value == "" && pr.PRIORIDADE == 99 && pr.TIPO == "related" && (pr.POSICAO == 8 || pr.POSICAO == 0))
                {
        ...
        protected void txtUpsell3_TextChanged(object sender, EventArgs e)
        {
            var p = eController.ObterMagentoProdutoConfigPorSKU(txtUpsell3.Text.Trim());
            if (p != null)
            {
                var codigoTemp = "0";

                var temp = eController.ObterEcomRelacionadoTempParaSKU(Convert.ToInt32(hidCodigoEcom.Value), "upsell", 2, 3);
                if (temp != null)
                {
                    codigoTemp = temp.CODIGO.ToString();
                    AtualizarRelFIXO(codigoTemp, true, 3, p.SKU, p.CODIGO);
                    hidUpSell3.Value = codigoTemp;
                    cbUpSell3.Enabled = false;
                    cbUpSell3.Checked = true;
                    imgUpSell3.ImageUrl = p.FOTO_FRENTE_CAB;
                }
            }
            else
            {
                if (hidUpSell3.Value != "")
                    AtualizarRelFIXO(hidUpSell3.Value, false, 0, "");

                txtUpsell3.Text = "";
                txtUpsell3.Enabled = true;
                cbUpSell3.Enabled = true;
                cbUpSell3.Checked = false;
            }
        }
        protected void txtUpsell4_TextChanged(object sender, EventArgs e)
        {
            var p = eController.ObterMagentoProdutoConfigPorSKU(txtUpsell4.Text.Trim());
            if (p != null)
            {
                var codigoTemp = "0";

                var temp = eController.ObterEcomRelacionadoTempParaSKU(Convert.ToInt32(hidCodigoEcom.Value), "upsell", 2, 4);
                if (temp != null)
                {
                    codigoTemp = temp.CODIGO.ToString();
                    AtualizarRelFIXO(codigoTemp, true, 4, p.SKU, p.CODIGO);
                    hidUpSell4.Value = codigoTemp;
                    cbUpSell4.Enabled = false;
                    cbUpSell4.Checked = true;
                    imgUpSell4.ImageUrl = p.FOTO_FRENTE_CAB;
                }
            }
            else
            {
                if (hidUpSell4.Value != "")
                    AtualizarRelFIXO(hidUpSell4.Value, false, 0, "");

                txtUpsell4.Text = "";
                txtUpsell4.Enabled = true;
                cbUpSell4.Enabled = true;
                cbUpSell4.Checked = false;
            }
        }
        ...
        protected void txtRelated3_TextChanged(object sender, EventArgs e)
        {
            ...
            if (p != null)
            {
                ...
                var temp = eController.ObterEcomRelacionadoTempParaSKU(Convert.ToInt32(hidCodigoEcom.Value), "related", 99, 7);
                if (temp != null)
                {
                    codigoTemp = temp.CODIGO.ToString();
                    AtualizarRelFIXO(codigoTemp, true, 7, p.SKU, p.CODIGO);
        ...
        protected void txtRelated4_TextChanged(object sender, EventArgs e)
        {
            ...
            if (p != null)
            {
                ...
                var temp = eController.ObterEcomRelacionadoTempParaSKU(Convert.ToInt32(hidCodigoEcom.Value), "related", 99, 8);
                if (temp != null)
                {
                    codigoTemp = temp.CODIGO.ToString();
                    AtualizarRelFIXO(codigoTemp, true, 8, p.SKU, p.CODIGO);
        ...
        protected void btAbrirProdutosComprados_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Abrir pop-up
                var _url = "fnAbrirTelaCadastro('../mod_ecom/ecom_rel_config_rel_criar_random_compra.aspx?prod=" + produto + "&cor=" + cor + "');";
        ...
        protected void btAtualizarMagento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (produtos == null || produtos.Count() < 8)
                {
                ...
                mag.DesassociarProdutoComOutrosProdutos(txtSKU.Text.Trim());
                ...
                var linkedSkusRelated = produtos.Where(x => x.TIPO == "related").Select(x => x.ECOM_PRODUTO2.SKU).ToList();
                mag.AssociarProdutoComOutrosProdutos(txtSKU.Text.Trim(), linkedSkusRelated, "related");

                var linkedSkusUpSell = produtos.Where(x => x.TIPO == "upsell").Select(x => x.ECOM_PRODUTO2.SKU).ToList();
                mag.AssociarProdutoComOutrosProdutos(txtSKU.Text.Trim(), linkedSkusUpSell, "upsell");
