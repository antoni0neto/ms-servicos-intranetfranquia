...
{
    public partial class ecomv2_cad_produto : System.Web.UI.Page
    {
        ...
        protected void btAbrir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (bt != null)
                {
                    ...
                    //Abrir pop-up
                    url = "fnAbrirTelaCadastroMaior('ecomv2_cad_produto_edit.aspx?co=" + colecao + "&p=" + produto + "&c=" + cor + "');";
        ...
        protected void btAtualizarCAT_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                mag.AssociarCategorias(ecomProduto);
        ...
        protected void btAtualizarPRECO_Click(object sender, ImageClickEventArgs e)
        {
            GridViewRow row = null;
            try
            {
                ...
                string cor = gvProduto.DataKeys[row.RowIndex].Values[2].ToString().Trim();
                var mag = new MagentoV2();
                var ecomProdutoConfig = eController.ObterMagentoProdutoConfig(produto, cor);
                mag.AtualizarProduto(ecomProdutoConfig, updateImage: false);
                if (row != null) row.BackColor = Color.LightPink;
                CarregarJQuery();
            }
            catch (Exception ex)
            {
