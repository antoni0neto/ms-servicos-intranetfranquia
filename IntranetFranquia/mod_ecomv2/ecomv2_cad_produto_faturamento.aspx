<%@ Page Title="Faturamento" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecomv2_cad_produto_faturamento.aspx.cs" Inherits="Relatorios.ecomv2_cad_produto_faturamento" %>
                    ...
                    <tr>
                        <td colspan="2">
                            <fieldset>
                                <legend>Loggi</legend>
                                <div class="rounded_corners">
                                    <asp:gridview id="gvFaturamentoLoggi" runat="server" width="100%" autogeneratecolumns="False"
                                        forecolor="#333333" style="background: white" onrowdatabound="gvFaturamento_RowDataBound"
                                        showfooter="true" datakeynames="PEDIDO">
                                        <HeaderStyle BackColor="GradientActiveCaption" HorizontalAlign="Center"></HeaderStyle>
                                        <FooterStyle BackColor="GradientActiveCaption" HorizontalAlign="Center" />
