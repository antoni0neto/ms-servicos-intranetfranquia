<%@ Page Title="Estoque Ecommerce - Salable" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"
    CodeBehind="ecomv2_produto_magento_estoque_salable.aspx.cs" Inherits="Relatorios.ecomv2_produto_magento_estoque_salable" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <div>
        <span style="font-family: Calibri; font-size: 14px;">Módulo do E-Commerce&nbsp;&nbsp;>&nbsp;&nbsp;Estoque&nbsp;&nbsp;>&nbsp;&nbsp;Estoque Ecommerce Salable</span>
    ...
    <div class="login">
        <fieldset style="padding-top: 0;">
            <legend>Estoque Ecommerce Salable</legend>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td>Grupo Produto</td>
                    <td>Produto</td>
                    <td>Salable maior que Estoque</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlDivergente" runat="server" Width="200px" Height="21px">
                ...
                <tr>
                    <td colspan="5">
                        <asp:Button ID="btBuscar" runat="server" Text="Buscar Estoque Salable" Width="200px" OnClick="btBuscar_Click" />
                        &nbsp;       
                ...
                <tr>
                    <td colspan="5">
                        <asp:CheckBox ID="chkAtualizarSalable" runat="server" Checked="false" />
                        Atualizar Estoque Salable?
                    </td>
                </tr>
                <tr>
                    <td colspan="5">&nbsp;
                                            ...
                                            <div class="rounded_corners">
                                                <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ESTOQUE_SALABLE" HeaderText="Estoque Salable" HeaderStyle-Width="110px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="ESTOQUE_SALABLE" ItemStyle-Font-Size="Smaller" />
                                                    </Columns>
                                                </asp:GridView>
                                            </div>
                                        </td>
