<%@ Page Title="Faturamento" Language="C#" AutoEventWireup="true" CodeBehind="ecomv2_cad_produto_faturamento_pop.aspx.cs"
    Inherits="Relatorios.ecomv2_cad_produto_faturamento_pop" %>
                    ...
                    <div>
                        <fieldset>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtPedido" runat="server" Width="237px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCLIFOR" runat="server" Width="186px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td colspan="2" style="width: 400px;">
                                        <asp:TextBox ID="txtCliente" runat="server" Width="384px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDataPedido" runat="server" Width="276px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtPedidoExterno" runat="server" Width="237px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtTransportadora" runat="server" Width="582px" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtQtde" runat="server" Width="276px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="width: 260px;">
                                        <asp:TextBox ID="txtVolume" runat="server" Width="237px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="txtPeso" runat="server" Width="186px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td style="width: 160px;">
                                        <asp:TextBox ID="txtTipoFrete" runat="server" Width="146px" Enabled="false"></asp:TextBox>
                                    </td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtValorFrete" runat="server" Width="276px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>-
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtRastreioMP" runat="server" Width="237px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td colspan="4">
                                        <asp:TextBox ID="txtPedidoMP" runat="server" Width="186px" CssClass="alinharDireita" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="labRastreioLoggi" runat="server" Text="Rastreio Loggi"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlFilial" Height="21px" Width="246px">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmissao" runat="server" MaxLength="10" Width="226px"
                                            onkeypress="return fnValidarData(event);" CssClass="alinharDireita"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtRastreioLoggi" runat="server" Width="276px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
