...
{
    public partial class ecomv2_pedido_mag_det : System.Web.UI.Page
    {
        ...
        protected void btGerarCupom_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var valorCupom = Convert.ToDouble(txtCupomVal.Text);
                ...
                var cupomResult = mag.GerarCupom(cupom, valorCupom, freteGratis);
                ...
                if (cupomResult.CouponId > 0)
                {
                    ...
                    pedidoCupom.VALOR = Convert.ToDecimal(valorCupom);
                    pedidoCupom.DATA_CRIACAO = DateTime.Now;
                    pedidoCupom.USUARIO = ((USUARIO)Session["USUARIO"]).CODIGO_USUARIO;
                    pedidoCupom.ID_CUPOM = cupomResult.CouponId;
                    pedidoCupom.ID_RULE = Convert.ToInt32(cupomResult.RuleId);
                    pedidoCupom.VERSAO = 2;
        ...
        protected void btExcluirCupom_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                var pedidoCupom = ecomController.ObterPedidoCupomPorCodigo(txtPedidoExterno.Text, cupom, 2);
                if (pedidoCupom != null)
                {
                    //excluir do magento
                    var mag = new MagentoV2();
                    mag.ExcluirCupom(pedidoCupom.ID_CUPOM, Convert.ToInt32(pedidoCupom.ID_RULE));
