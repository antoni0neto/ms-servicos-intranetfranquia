<%@ Page Title="SaidaProduto" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="VendaProduto.aspx.cs" Inherits="Relatorios.VendaProduto" %>
    ...
    <div class="accountInfo">
        ...
        <fieldset class="login">
            ...
            <div style="width: 900px;" class="alinhamento">
                ...
                <div style="width: 200px;"  class="alinhamento">
                    <label>Produto:&nbsp; </label>
                    <asp:DropDownList runat="server" ID="ddlProduto" DataValueField="PRODUTO1" AutoPostBack="true"
                        DataTextField="DESC_PRODUTO" Height="26px" 
                ...
                <div style="width: 100px;"  class="alinhamento">
                    ...
                    <asp:TextBox ID="TextBoxCodigoProduto" runat="server" CssClass="textEntry" AutoPostBack="true"
                        MaxLength="10" Height="22px" Width="100px" 
                        ontextchanged="TextBoxCodigoProduto_TextChanged"></asp:TextBox>
                </div>
            </div>
        </fieldset>
        <div>
            <asp:Button runat="server" ID="ButtonPesquisarSaida" Text="Buscar Vendas em Loja" OnClick="ButtonPesquisarSaida_Click" ValidationGroup="saida"/>
            <asp:ValidationSummary ID="ValidationSummarySaida" runat="server" ValidationGroup="entrada" ShowMessageBox="true" ShowSummary="false" />
            <asp:Label runat="server" ID="lblMensagemSaida" ForeColor="Red"></asp:Label>
        </div>
                ...
                <td>
                    <asp:GridView id="GridViewSaida" runat="server" Width="100%" CssClass="DataGrid_Padrao" PageSize="10" AllowPaging="True" AutoGenerateColumns="False" onpageindexchanging="GridViewSaida_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="QTDE_VENDA" HeaderText="Quantidade" />
                        </Columns>
