<%@ Page Title="Fábrica - Relatório de Divergência" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="estoque_mercadoria_rel_fabrica.aspx.cs" Inherits="Relatorios.estoque_mercadoria_rel_fabrica"
        ...
        <ContentTemplate>
            ...
            <div class="accountInfo">
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Controle de Estoque&nbsp;&nbsp;>&nbsp;&nbsp;Estoque
                    Loja&nbsp;&nbsp;>&nbsp;&nbsp;Fábrica - Relatório de Divergência</span>
                <div style="float: right; padding: 0;">
                    <a href="estoque_menu.aspx" class="alink" title="Voltar">Voltar</a>
                </div>
                <hr />
                <fieldset>
                    <legend>Fábrica - Relatório de Divergência</legend>
                                        ...
                                        <div class="rounded_corners">
                                            <asp:GridView ID="gvMercadoria" runat="server" Width="100%" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="NF_SAIDA" HeaderText="NF" HeaderStyle-Width="110px"
                                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                                    <asp:BoundField DataField="SERIE_NF" HeaderText="Série" HeaderStyle-Width="40px"
                                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
