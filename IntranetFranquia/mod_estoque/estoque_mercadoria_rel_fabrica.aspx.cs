...
{
    public partial class estoque_mercadoria_rel_fabrica : System.Web.UI.Page
    {
        ...
        private void CarregarStatusMercadoria()
        {
            ...
            List<SP_GERAR_RELATORIO_MERCADORIA_FABResult> _relMercadoria = new List<SP_GERAR_RELATORIO_MERCADORIA_FABResult>();
            _relMercadoria = estoqueController.GerarRelatorioMercadoriaFabrica(txtProduto.Text.Trim(), ddlFilial.SelectedItem.Text, txtNF.Text.Trim(), dataini, datafim);
        ...
        protected void gvMercadoria_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    SP_GERAR_RELATORIO_MERCADORIA_FABResult _finalizado = e.Row.DataItem as SP_GERAR_RELATORIO_MERCADORIA_FABResult;
