<%@ Page Title="Fábrica - Recebimento de Mercadoria" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="estoque_mercadoria_recebimento_fabrica.aspx.cs" Inherits="Relatorios.estoque_mercadoria_recebimento_fabrica"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Controle de Estoque&nbsp;&nbsp;>&nbsp;&nbsp;Estoque Fábrica&nbsp;&nbsp;>&nbsp;&nbsp;Fábrica - Recebimento de Mercadoria</span>
            ...
            <fieldset>
                <legend>
                    <asp:Label ID="labTitulo" runat="server" Text="Fábrica - Recebimento de Mercadoria"></asp:Label></legend>
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <div class="rounded_corners">
                                <asp:GridView ID="gvNotaMercadoria" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NF_SAIDA" HeaderText="NF" HeaderStyle-Width="200px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
                                        <asp:BoundField DataField="SERIE_NF" HeaderText="Série" HeaderStyle-Width="130px"
                                            ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="FILIAL" HeaderText="Empresa Emissora" ItemStyle-HorizontalAlign="Left"
                    ...
                    <tr>
                        <td colspan="3">&nbsp;
                            ...
                            <asp:HiddenField ID="hidNomeCliFor" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <div class="rounded_corners">
                                <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DESC_COR_PRODUTO" HeaderText="Cor" HeaderStyle-Width="180px" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:BoundField DataField="QTDE_TOTAL" HeaderText="Quantidade" ItemStyle-HorizontalAlign="Center"
