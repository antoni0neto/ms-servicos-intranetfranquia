...
{
    public partial class FundoFixoEncerrado : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string mensagem = Session["CodigoControle"].ToString();

            txtMensagem.Text = "Anote o código de fechamento: "+mensagem;
        }
