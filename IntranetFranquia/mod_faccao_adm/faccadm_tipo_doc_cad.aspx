<%@ Page Title="Cadastro de Tipos de Documento" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="faccadm_tipo_doc_cad.aspx.cs" Inherits="Relatorios.faccadm_tipo_doc_cad"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="up1" runat="server">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo de Facção Administrativo&nbsp;&nbsp;>&nbsp;&nbsp;Cadastros&nbsp;&nbsp;>&nbsp;&nbsp;Cadastro de Tipos de Documento</span>
            ...
            <div style="float: left; width: 1200px; margin-left: 8%;">
                <fieldset>
                    <legend>Cadastro de Tipos de Documento</legend>
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="tb">
                        <tr style="height: 10px; vertical-align: bottom;">
                            <td>
                                <asp:Label ID="labDocumento" runat="server" Text="Documento"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="labTipoVigencia" runat="server" Text="Tipo Vigência"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="width: 400px;">
                                <asp:TextBox ID="txtDocumento" runat="server" Width="390px"></asp:TextBox>
                            </td>
                            <td style="width: 220px;">
                                <asp:DropDownList ID="ddlTipoVigencia" Height="21px" runat="server" Width="214px">
                                    <asp:ListItem Text="Selecione" Value=""></asp:ListItem>
                                    <asp:ListItem Text="Mensal" Value="M"></asp:ListItem>
                                    <asp:ListItem Text="Anual" Value="A"></asp:ListItem>
                                    <asp:ListItem Text="Vitalício" Value="R"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="width: 150px;">
                                <asp:DropDownList ID="ddlStatus" Height="21px" runat="server" Width="144px">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:TextBox ID="txtDescricao" runat="server" Width="760px"></asp:TextBox>
                            </td>
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="gvTipoDocumento" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DOCUMENTO" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                    HeaderText="Documento" />
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                    HeaderText="Tipo Vigência" HeaderStyle-Width="270px">
                                                    <ItemTemplate>
                                                        <asp:Literal ID="litTipoVigencia" runat="server"></asp:Literal>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                    HeaderText="Status" HeaderStyle-Width="270px">
                                                    <ItemTemplate>
