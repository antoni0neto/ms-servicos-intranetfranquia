<%@ Page Title="Transferência de Fotos para Seleção" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecom_cad_foto_maquina_transfer.aspx.cs" Inherits="Relatorios.ecom_cad_foto_maquina_transfer" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="width: 160px;">
                                    <asp:DropDownList ID="ddlDataFoto" runat="server" Width="154px" Height="22px" DataTextField="" DataValueField=""></asp:DropDownList>
                                </td>
                                <td style="width: 160px;">
                                    <asp:DropDownList ID="ddlDiretorio" runat="server" Width="154px" Height="22px">
                                        <asp:ListItem Value="" Text="Selecione"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="FotosHandbookOnlineGeral"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="FotoLookBookGeral"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                        ...
                                        <asp:GridView ID="gvFotoMaquina" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btSalvar" runat="server" Enabled="true" Width="40px" Text=">>" OnClick="btSalvar_Click" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
