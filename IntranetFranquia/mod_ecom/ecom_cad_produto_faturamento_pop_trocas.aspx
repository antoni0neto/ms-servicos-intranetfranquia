<%@ Page Title="Faturamento Trocas" Language="C#" AutoEventWireup="true" CodeBehind="ecom_cad_produto_faturamento_pop_trocas.aspx.cs"
    Inherits="Relatorios.ecom_cad_produto_faturamento_pop_trocas" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo do E-Commerce&nbsp;&nbsp;>&nbsp;&nbsp;Controle de Pedido&nbsp;&nbsp;>&nbsp;&nbsp;Faturamento Trocas</span>
                    ...
                    <div>
                        <fieldset>
                            <legend>Faturamento Trocas</legend>
