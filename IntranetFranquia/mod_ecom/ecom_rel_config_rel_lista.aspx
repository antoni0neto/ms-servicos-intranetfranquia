<%@ Page Title="Relacionados - Criar Produto Relacionado" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecom_rel_config_rel_lista.aspx.cs" Inherits="Relatorios.ecom_rel_config_rel_lista" %>
                        ...
                        <tr>
                            ...
                            <td style="width: 200px">
                                <asp:DropDownList ID="ddlGriffe" runat="server" Width="194px" Height="21px" DataTextField="GRIFFE"
                                    DataValueField="GRIFFE" OnSelectedIndexChanged="ddlFiltroCaract_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </td>
                            <td style="width: 180px">
                                <asp:DropDownList ID="ddlGrupo" runat="server" Width="174px" Height="21px" DataValueField="GRUPO_PRODUTO" DataTextField="GRUPO_PRODUTO"
                                    OnSelectedIndexChanged="ddlFiltroCaract_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td colspan="9">
                                <fieldset>
                                    ...
                                    <div style="text-align: right; width: 100%; margin-top: -5px;">
                                        <asp:Label ID="labCaract" runat="server" Text="*Para utilizar as características, selecione a Griffe e o Grupo." ForeColor="Red" Font-Size="Smaller"></asp:Label>
                                    </div>
                                    <br />
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="width: 230px;">
                                                <asp:DropDownList ID="ddlTipoModelagem" runat="server" Width="224px" Height="21px" DataValueField="CODIGO" DataTextField="TIPO_MODELAGEM"></asp:DropDownList>
                                            </td>
                                            <td style="width: 230px;">
                                                <asp:DropDownList ID="ddlTipoTecido" runat="server" Width="224px" Height="21px" DataValueField="CODIGO" DataTextField="TIPO_TECIDO"></asp:DropDownList>
                                            </td>
                                            <td style="width: 230px;">
                                                <asp:DropDownList ID="ddlTipoManga" runat="server" Width="224px" Height="21px" DataValueField="CODIGO" DataTextField="TIPO_MANGA"></asp:DropDownList>
                                            </td>
                                            <td style="width: 230px;">
                                                <asp:DropDownList ID="ddlTipoGola" runat="server" Width="224px" Height="21px" DataValueField="CODIGO" DataTextField="TIPO_GOLA"></asp:DropDownList>
                                            </td>
                                            <td style="width: 230px;">
                                                <asp:DropDownList ID="ddlTipoComprimento" runat="server" Width="224px" Height="21px" DataValueField="CODIGO" DataTextField="TIPO_COMPRIMENTO"></asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlTipoEstilo" runat="server" Width="224px" Height="21px" DataValueField="CODIGO" DataTextField="TIPO_ESTILO"></asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                                                    ...
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="ESTOQUE" HeaderText="Estoque" SortExpression="ESTOQUE" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
