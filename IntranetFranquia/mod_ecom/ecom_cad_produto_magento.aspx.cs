...
{
    public partial class ecom_cad_produto_magento : System.Web.UI.Page
    {
        ...
        protected void gvProduto_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.DataItem != null)
                {
                    ...
                    if (!headerTam10.Contains(prod.TAMANHO_10))
                        headerTam10 = headerTam10 + prod.TAMANHO_10 + "-";
                    if (!headerTam11.Contains(prod.TAMANHO_11))
                        headerTam11 = headerTam11 + prod.TAMANHO_11 + "-";
                    if (!headerTam12.Contains(prod.TAMANHO_12))
                        headerTam12 = headerTam12 + prod.TAMANHO_12 + "-";
                    if (!headerTam13.Contains(prod.TAMANHO_13))
                        headerTam13 = headerTam13 + prod.TAMANHO_13 + "-";
                    if (!headerTam14.Contains(prod.TAMANHO_14))
                        headerTam14 = headerTam14 + prod.TAMANHO_14 + "-";
            ...
            try
            {
                ...
                foreach (GridViewRow row in gvProduto.Rows)
                {
                    ...
                    if (cb.Checked)
                    {
                        ...
                        //MATRIZ
                        mag.SalvarProdutoMagentoEstoque(codigo);

                    }
                }

                //ASSOCIAR PRODUTOS
                //msg = "Associando Produtos...";
                ...
                //foreach (var prodAsso in produtosAsso)
                //{
                //    mag.AssociarSkus(prodAsso);
                //}
