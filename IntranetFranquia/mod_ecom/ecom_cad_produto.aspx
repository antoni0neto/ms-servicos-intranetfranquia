<%@ Page Title="Cadastro de Produtos E-Commerce" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecom_cad_produto.aspx.cs" Inherits="Relatorios.ecom_cad_produto" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 140px">
                                <asp:TextBox ID="txtProduto" runat="server" onkeypress="return fnValidarNumero(event);" Width="130px"></asp:TextBox>
                            </td>
                                                        ...
                                                        <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Cat" HeaderStyle-Width="65px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="btAtualizarCAT" runat="server" ImageUrl="~/Image/update.png" Width="15px" AlternateText="CAT" OnClick="btAtualizarCAT_Click" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
