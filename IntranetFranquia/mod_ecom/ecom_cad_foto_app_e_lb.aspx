<%@ Page Title="Seleção de Fotos App/Lookbook" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecom_cad_foto_app_e_lb.aspx.cs" Inherits="Relatorios.ecom_cad_foto_app_e_lb" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Módulo do E-Commerce&nbsp;&nbsp;>&nbsp;&nbsp;Cadastro&nbsp;&nbsp;>&nbsp;&nbsp;Seleção de Fotos App/Lookbook</span>
            ...
            <div class="login">
                <fieldset style="padding-top: 0;">
                    <legend>Seleção de Fotos App/Lookbook</legend>
