<%@ Page Title="Rastreio de Pedido" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecom_mandae_entrega.aspx.cs" Inherits="Relatorios.ecom_mandae_entrega" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="width: 210px;">
                            <asp:TextBox ID="txtTrackNumberFiltro" runat="server" Width="200px"></asp:TextBox>
                        </td>
                        <td style="width: 210px;">
                            <asp:TextBox ID="txtPedidoLinxFiltro" runat="server" Width="200px"></asp:TextBox>
                        </td>
                        <td style="width: 210px;">
                            <asp:TextBox ID="txtPedidoExternoFiltro" runat="server" Width="200px"></asp:TextBox>
                        </td>
                        <td style="width: 210px;">
                        ...
                        <td colspan="5">
                            <asp:Panel ID="pnlMandae" runat="server">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td style="width: 210px;">
                                            <asp:TextBox ID="txtTrackNumber" runat="server" Width="150px" Enabled="false"></asp:TextBox>&nbsp;
                                            <asp:Button ID="btMandae" runat="server" Text=">>" OnClick="btMandae_Click" Width="42px" />
                                        </td>
                                        <td style="width: 210px;">
                                            <asp:TextBox ID="txtPedidoLinx" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td style="width: 210px;">
                                            <asp:TextBox ID="txtPedidoExterno" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td style="width: 210px;">
                                            <asp:TextBox ID="txtCliente" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td style="width: 210px;">
                                            <asp:TextBox ID="txtServico" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                                        </td>
