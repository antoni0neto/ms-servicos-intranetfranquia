<%@ Page Title="Vendas - Pedido" Language="C#" AutoEventWireup="true" CodeBehind="ecom_pedido_mag_det.aspx.cs"
    Inherits="Relatorios.ecom_pedido_mag_det" %>
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" class="bodyMaterial">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px;">
                                                    <asp:TextBox ID="txtCupomVal" runat="server" Enabled="true" Width="190px" onkeypress="return fnValidarNumeroDecimal(event);"></asp:TextBox>
                                                </td>
                                                <td style="width: 180px;">
                                                    <asp:TextBox ID="txtNFEntrada" runat="server" Enabled="true" Width="170px" onkeypress="return fnValidarNumero(event);"></asp:TextBox>
                                                </td>
                                                <td>
