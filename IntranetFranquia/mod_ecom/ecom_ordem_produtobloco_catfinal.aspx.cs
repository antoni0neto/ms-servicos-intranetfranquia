...
{
    public partial class ecom_ordem_produtobloco_catfinal : System.Web.UI.Page
    {
        ...
        protected void btAtualizarMagento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var p in produtos)
                {
                    ...
                    {
                        mysqlController.AtualizarRelevanciaProdutoCat(counter.ToString(), p.ECOM_GRUPO_PRODUTO.ToString(), p.ID_PRODUTO_MAG.ToString());
