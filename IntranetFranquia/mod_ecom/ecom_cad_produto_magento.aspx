<%@ Page Title="Liberação Estoque" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ecom_cad_produto_magento.aspx.cs" Inherits="Relatorios.ecom_cad_produto_magento" %>
                                                    ...
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="DESC_COR_PRODUTO" HeaderText="Descrição Cor" SortExpression="DESC_COR_PRODUTO" />
                                                                ...
                                                                <asp:BoundField DataField="QTDE_10" HeaderText="-" SortExpression="QTDE_10" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
                                                                <asp:BoundField DataField="QTDE_11" HeaderText="-" SortExpression="QTDE_11" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
                                                                <asp:BoundField DataField="QTDE_12" HeaderText="-" SortExpression="QTDE_12" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
                                                                <asp:BoundField DataField="QTDE_13" HeaderText="-" SortExpression="QTDE_13" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
                                                                <asp:BoundField DataField="QTDE_14" HeaderText="-" SortExpression="QTDE_14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
