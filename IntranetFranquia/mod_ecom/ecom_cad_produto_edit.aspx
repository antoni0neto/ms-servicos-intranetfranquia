<%@ Page Title="Cadastro de Produtos E-Commerce" Language="C#" AutoEventWireup="true" CodeBehind="ecom_cad_produto_edit.aspx.cs"
    Inherits="Relatorios.ecom_cad_produto_edit" %>
                        ...
                        <fieldset>
                            ...
                            <fieldset>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 185px;">
                                            <asp:TextBox ID="txtSKU" runat="server" Width="175px"></asp:TextBox>
                                        </td>
                                        <td style="width: 185px;">
                                            <asp:TextBox ID="txtCorLinx" runat="server" Width="175px"></asp:TextBox>
                                        </td>
                                        <td style="width: 185px;">
                                        ...
                                        <td style="width: 185px;">
                                            <asp:TextBox ID="txtGrupoProduto" runat="server" Width="175px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtNomeProduto" runat="server" Width="360px"></asp:TextBox>
                                        </td>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtNomeProdutoMagento" runat="server" Width="360px" MaxLength="35" OnTextChanged="txtNomeProdutoMagento_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="labDataPrecoPromocionalDe" runat="server" Text="Preço Promocional De"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="labDataPrecoPromocionalAte" runat="server" Text="Preço Promocional Até"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtDataPrecoPromoDe" runat="server" CssClass="alinharDireita" Width="175px" onkeypress="return fnValidarData(event);"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtDataPrecoPromoAte" runat="server" CssClass="alinharDireita" Width="175px" onkeypress="return fnValidarData(event);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                        ...
                                        <td>
                                            <asp:Label ID="labHabilitado" runat="server" Text="Habilitado"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:TextBox ID="txtURLProduto" runat="server" Width="360px" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlCaixa" runat="server" Width="179px" DataValueField="CODIGO" DataTextField="DESCRICAO"></asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlVisibilidade" runat="server" Width="179px" Height="21px">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlHabilitado" runat="server" Width="179px" Height="21px" Enabled="false">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtStatusCadastro" runat="server" Width="175px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <asp:TextBox ID="txtObservacao" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <asp:TextBox ID="txtMetaTitulo" runat="server" Width="100%" MaxLength="63"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <asp:TextBox ID="txtMetaKeyword" runat="server" Width="100%" MaxLength="300"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <asp:TextBox ID="txtMetaDescricao" runat="server" TextMode="MultiLine" Height="75px" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">&nbsp;</td>
