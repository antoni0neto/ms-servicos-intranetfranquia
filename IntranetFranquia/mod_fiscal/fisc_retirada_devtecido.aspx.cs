...
{
    public partial class fisc_retirada_devtecido : System.Web.UI.Page
    {
        ...
        #region "RETIRADA"
        private void CarregarRetiradaTecido()
        {
            var devEmissao = desenvController.ObterPedidoQtdeRetiradaBaixa();
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.DataItem != null)
                {
                    ...
                    if (pedidoQtde != null)
                    {
                        ...
                        Literal litNFDEV = e.Row.FindControl("litNFDEV") as Literal;
                        litNFDEV.Text = pedidoQtde.NF_DEV;

                        Literal litQtde = e.Row.FindControl("litQtde") as Literal;
                        litQtde.Text = (pedidoQtde.QTDE * -1.00M).ToString("###,###,###,##0.000");

                        Literal litDataDevolucao = e.Row.FindControl("litDataDevolucao") as Literal;
                        litDataDevolucao.Text = (pedidoQtde.DATA_RETIRADA == null) ? "-" : Convert.ToDateTime(pedidoQtde.DATA_RETIRADA).ToString("dd/MM/yyyy");
            ...
            try
            {
                ...
                if (b != null)
                {
                    ...
                    if (row != null)
                    {
                        ...
                        //Abrir pop-up
                        var url = "fnAbrirTelaCadastroMaior('fisc_retirada_devtecido_baixar.aspx?p=" + codigoDesenvQtde + "&t=" + "" + "');";
