<%@ Page Title="Emitir Nota" Language="C#" AutoEventWireup="true" CodeBehind="fisc_emissao_nf_devtecido_baixar.aspx.cs"
    Inherits="Relatorios.fisc_emissao_nf_devtecido_baixar" %>
        ...
        <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                <div style="margin-top: 10px; padding-left: 12px; padding-right: 12px; padding-bottom: -350px; background-color: White;">
                    <br />
                    <div>
                        <span style="font-family: Calibri; font-size: 14px;">Módulo Fiscal&nbsp;&nbsp;>&nbsp;&nbsp;Controle Fiscal&nbsp;&nbsp;>&nbsp;&nbsp;Emissão Nota Fiscal&nbsp;&nbsp;>&nbsp;&nbsp;Emitir Nota Devolução de Tecido</span>
                        ...
                        <fieldset>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFrete" runat="server" Width="190px" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Tecido</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNatureza" runat="server" Width="190px" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Quantidade</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPesoBruto" runat="server" Width="190px" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="5">&nbsp;</td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:DropDownList runat="server" ID="ddlFilial" Height="22px" Width="444px">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmissao" runat="server" MaxLength="10" Width="190px"
