<%@ Page Title="Mover Arquivos XML" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="admfis_leitura_xmlnfe_moverv2.aspx.cs" Inherits="Relatorios.admfis_leitura_xmlnfe_moverv2" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function moverArquivosXml() {
            ...
            $.ajax({
                type: 'POST',
                url: 'admfis_leitura_xmlnfe_moverv2.aspx/TransformarArquivos',
