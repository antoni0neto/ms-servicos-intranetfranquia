<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BuscaPorNomeCliente.aspx.cs" Inherits="Relatorios.BuscaPorNomeCliente" %>
        ...
        <fieldset class="login">
            <div style="width: 200px;" class="alinhamento">
                ...
                <div>
                    ...
                    <asp:TextBox ID="txtNomeCliente" runat="server" CssClass="pcRight" MaxLength="100" Height="16px" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorNomeCliente" runat="server" SetFocusOnError="true" Display="None" ErrorMessage="Preencha o campo Nome do Cliente" ControlToValidate="txtNomeCliente" ValidationGroup="valores"></asp:RequiredFieldValidator>
                </div>
            </div>
        </fieldset>
        <div>
