<%@ Page Title="Gincana de Natal 2021" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="mkt_gin_natal2021.aspx.cs" Inherits="Relatorios.mkt_gin_natal2021" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Gincana de Natal 2021</span>
                        ...
                        <td>
                            <fieldset style="padding-top: 0;">
                                ...
                                <div style="text-align: right; width: 100%;">
                                    <asp:Label ID="labRegraPA" runat="server" Text="*PA - Somente peças e calçados" ForeColor="Red" Font-Size="Smaller"></asp:Label>
                                </div>
                                <br />
                                <div id="accordionP">
                                    <h3>
                                        <asp:Label ID="labTitulo" runat="server" Text="Início da Pontuação - 01/12/2021"></asp:Label>
                                    </h3>
                                    <div>
                                                    ...
                                                    <div class="rounded_corners">
                                                        <asp:GridView ID="gvPrincipal" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="HOTTO_PONTO" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderText="Vendas Hotto" HeaderStyle-Width="220px" />
