<%@ Page Title="Gincana de Natal 2020" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="mkt_gin_natal2020.aspx.cs" Inherits="Relatorios.mkt_gin_natal2020" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <br />
            <div>
                <span style="font-family: Calibri; font-size: 14px;">Gincana de Natal 2020</span>
                    ...
                    <tr>
                        <td>
                            <fieldset style="padding-top: 0;">
                                ...
                                <div id="accordionP">
                                    <h3>
                                        <asp:Label ID="labTitulo" runat="server" Text="Início da Pontuação - 01/12/2020"></asp:Label>
                                    </h3>
                                    <div>
