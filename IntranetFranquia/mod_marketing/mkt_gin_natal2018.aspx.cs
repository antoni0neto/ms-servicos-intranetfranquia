...
{
    public partial class mkt_gin_natal2018 : System.Web.UI.Page
    {
        ...
        {
            var gincana = lojaController.ObterGincanaNAT2018();
            if (gincana != null)
            {
        ...
        protected void gvPrincipal_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    SP_OBTER_GINCANA_NAT2018Result gin = e.Row.DataItem as SP_OBTER_GINCANA_NAT2018Result;
