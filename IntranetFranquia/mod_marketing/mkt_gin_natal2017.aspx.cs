...
{
    public partial class mkt_gin_natal2017 : System.Web.UI.Page
    {
        ...
        {
            var gincana = lojaController.ObterGincana2017();
            if (gincana != null)
            {
        ...
        protected void gvPrincipal_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    SP_OBTER_GINCANA2017Result gin = e.Row.DataItem as SP_OBTER_GINCANA2017Result;
