<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="AlterarFechamentoCaixa.aspx.cs" Inherits="Relatorios.AlterarFechamentoCaixa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="accountInfo">
        <fieldset class="login">
                ...
                <tr>
                    <td valign="top">
                        <fieldset class="login">
                            ...
                            <label>
                                Loja:</label>
                            <asp:TextBox ID="txtLoja" runat="server" CssClass="textEntry" MaxLength="50" Height="16px"
                                Width="200px" Enabled="False"></asp:TextBox>
                            <label>
                                Data:</label>
                            <asp:TextBox ID="txtData" runat="server" CssClass="textEntry" MaxLength="50" Height="16px"
                                Width="200px" Enabled="False"></asp:TextBox>
                        </fieldset>
                        <fieldset class="login">
                            <legend>Venda</legend>
                        ...
                        <fieldset class="login">
                            ...
                            <div>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorDinheiro" runat="server"
                                    ErrorMessage="Valor Dinheiro Inválido !!!" SetFocusOnError="True" ControlToValidate="txtDinheiroDeposito"
                            ...
                            <div>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorCheque" runat="server"
                                    ErrorMessage="Valor Cheque Inválido !!!" SetFocusOnError="True" ControlToValidate="txtChequeDeposito"
                                    ValidationExpression="^[0-9]+(\,[0-9]{1,2})?$" ValidationGroup="valores" Display="None"> </asp:RegularExpressionValidator>
                            </div>
                            <div>
                                <label>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorChequePre" runat="server"
                                    ErrorMessage="Valor Cheque Pré Inválido !!!" SetFocusOnError="True" ControlToValidate="txtChequePreRetorno"
                                    ValidationExpression="^[0-9]+(\,[0-9]{1,2})?$" ValidationGroup="valores" Display="None"> </asp:RegularExpressionValidator>
                            </div>
                            <div>
                                <label>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorCartao" runat="server"
                                    ErrorMessage="Valor Cartão Inválido !!!" SetFocusOnError="True" ControlToValidate="txtCartaoRetorno"
                                    ValidationExpression="^[0-9]+(\,[0-9]{1,2})?$" ValidationGroup="valores" Display="None"> </asp:RegularExpressionValidator>
                            </div>
                            <div>
                                <label>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorComanda" runat="server"
                                    ErrorMessage="Valor Comanda Inválido !!!" SetFocusOnError="True" ControlToValidate="txtComanda"
                                    ValidationExpression="^[0-9]+(\,[0-9]{1,2})?$" ValidationGroup="valores" Display="None"> </asp:RegularExpressionValidator>
                            </div>
                            <div>
                                <label>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorRetirada" runat="server"
                                    ErrorMessage="Valor Retirada Inválido !!!" SetFocusOnError="True" ControlToValidate="txtRetirada"
                                    ValidationExpression="^[0-9]+(\,[0-9]{1,2})?$" ValidationGroup="valores" Display="None"> </asp:RegularExpressionValidator>
                            </div>
                            <div>
                                <label>
                            ...
                            <div>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorOutrosCartoes" runat="server"
                                    ErrorMessage="Valor Outros Cartões Inválido !!!" SetFocusOnError="True" ControlToValidate="txtOutrosCartoes"
                                    ValidationExpression="^[0-9]+(\,[0-9]{1,2})?$" ValidationGroup="valores" Display="None"> </asp:RegularExpressionValidator>
                            </div>
                            <div>
                                <label>
                        ...
                        <fieldset class="login">
                            ...
                            <div>
                                ...
                                <asp:TextBox ID="txtObsGeral" runat="server" CssClass="textEntry" MaxLength="1000"
                                    Height="41px" Width="300px" TextMode="MultiLine"></asp:TextBox>
                            </div>
                        </fieldset>
                        <fieldset class="login">
                            <legend>Observação</legend>
                            <div>
                                <label>
                                    Observação Matriz:</label>
                                <asp:TextBox ID="txtObsMatriz" runat="server" CssClass="textEntry" MaxLength="1000"
                                    Height="41px" Width="300px" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                            </div>
                        </fieldset>
                    </td>
                </tr>
            ...
            <div>
                <asp:Button runat="server" ID="btConferir" Text="Conferir Caixa" OnClick="btConferir_Click" Enabled="false" Width="150px" />
            </div>
        </fieldset>
    </div>
</asp:Content>
