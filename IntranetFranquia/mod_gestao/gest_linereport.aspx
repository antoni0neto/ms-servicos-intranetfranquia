<%@ Page Title="Line Report Venda Líquida" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="gest_linereport.aspx.cs" Inherits="Relatorios.gest_linereport" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <span style="font-family: Calibri; font-size: 14px;">Módulo de Gestão&nbsp;&nbsp;>&nbsp;&nbsp;Relatórios
            de Gestão&nbsp;&nbsp;>&nbsp;&nbsp;Line Report Venda Líquida</span>
    ...
    <div class="accountInfo">
        <fieldset class="login">
            <legend>Line Report Venda Líquida</legend>
            ...
            <div style="width: 5000px;">
                <asp:GridView ID="GridViewMovimentoProduto" runat="server" Width="100%" CssClass="DataGrid_Padrao"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="dif_2011_2012" HeaderStyle-Width="180px" HeaderText="Dif AnoAnterior/AnoAtual"
                            Visible="false" />
                        <asp:BoundField DataField="var_markup_original_antigo" HeaderStyle-Width="180px"
                            HeaderText="Markup Original Tradicional" />
