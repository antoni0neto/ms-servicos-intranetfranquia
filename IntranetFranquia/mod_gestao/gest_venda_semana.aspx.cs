...
{
    public partial class gest_venda_semana : System.Web.UI.Page
    {
        ...
        List<SP_OBTER_VENDA_PRODUTO_SEMANAResult> gVendaProduto = new List<SP_OBTER_VENDA_PRODUTO_SEMANAResult>();
        const string VENDA_PRODUTO_SEMANA = "VENDA_PRODUTO_SEMANA1";
        ...
        private List<SP_OBTER_VENDA_PRODUTO_SEMANAResult> ObterVendaProdutoSemana(DateTime dataIni, string colecao, int desenvOrigem, string grupoProduto, string produto, string nome, string tecido, string corFornecedor, string griffe, string produtoAcabado, string signed, string signedNome, string fornecedor, string colecaoLINX, string subGrupoProduto)
        {
            ...
            gVendaProduto = lojaController.ObterVendaProdutoSemana(dataIni, colecao, desenvOrigem, grupoProdutoCon, produto, nome, tecido, corFornecedor, griffeCon, produtoAcabado, signed, signedNome, fornecedor, colecaoLinxCon, subGrupoProduto);
        ...
        protected void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var produtos = ObterVendaProdutoSemana(semanaSel.DATA_INI, ddlColecoes.SelectedValue.Trim(), desenvOrigem, "", txtModelo.Text.Trim(), txtNome.Text.Trim(), ddlTecido.SelectedValue, ddlCorFornecedor.SelectedValue, "", ddlProdutoAcabado.SelectedValue, ddlSigned.SelectedValue, ddlSignedNome.SelectedValue, ddlFornecedor.SelectedValue.Trim(), "", ddlSubGrupoProduto.SelectedValue.Trim());
        ...
        protected void gvProduto_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    SP_OBTER_VENDA_PRODUTO_SEMANAResult prod = e.Row.DataItem as SP_OBTER_VENDA_PRODUTO_SEMANAResult;
                    ...
                    var semanaHistorico = lojaController.ObterVendaProdutoSemanaHistorico(prod.PRODUTO, prod.COR, prod.DATA_INICIAL).Where(p => p.DATA_INI != prod.DATA_INI);
        ...
        protected void gvProduto_Sorting(object sender, GridViewSortEventArgs e)
        {
            if (Session[VENDA_PRODUTO_SEMANA] != null)
            {
                ...
                IEnumerable<SP_OBTER_VENDA_PRODUTO_SEMANAResult> produtos = (IEnumerable<SP_OBTER_VENDA_PRODUTO_SEMANAResult>)Session[VENDA_PRODUTO_SEMANA];
        ...
        protected void gvProdutoHistorico_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.DataItem != null)
                {
                    FN_OBTER_VENDA_SEMANA_PRODUTOResult prod = e.Row.DataItem as FN_OBTER_VENDA_SEMANA_PRODUTOResult;
        ...
        protected void btLimparRemarcacao_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gvProduto.DataSource = new List<SP_OBTER_VENDA_PRODUTO_SEMANAResult>();
                gvProduto.DataBind();
