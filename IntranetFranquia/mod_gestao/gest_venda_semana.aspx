<%@ Page Title="Venda de Produtos Semana" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="gest_venda_semana.aspx.cs" Inherits="Relatorios.gest_venda_semana"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <fieldset>
        <legend>
            <asp:Label ID="labTitulo" runat="server" Text="Venda de Produtos Semana"></asp:Label></legend>
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="7">
                    <asp:DropDownList ID="ddlTipo" runat="server" Width="174px" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <asp:ListItem Value="01" Text="PEÇA"></asp:ListItem>
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: right;">
                    ...
                    <asp:Button ID="btGerarTXT" runat="server" Enabled="true" Text="Gerar TXT" Width="150px" OnClick="btGerarTXT_Click" />&nbsp;
                    <asp:Button ID="btLimparRemarcacao" runat="server" Enabled="true" Text="Limpar Remarcação" Width="150px" OnClick="btLimparRemarcacao_Click" OnClientClick="javascript: return confirm('Todos os preços serão apagados. Confirma esta operação?');" />
                </td>
            </tr>
                    ...
                    <div class="rounded_corners">
                        <asp:GridView ID="gvProduto" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Estoque Loja" ItemStyle-HorizontalAlign="Center" SortExpression="ESTOQUE_LOJA" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
