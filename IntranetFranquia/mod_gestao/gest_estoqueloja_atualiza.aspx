<%@ Page Title="Atualizar Movimento Estoque Loja" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="gest_estoqueloja_atualiza.aspx.cs" Inherits="Relatorios.gest_estoqueloja_atualiza" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span style="font-family: Calibri; font-size: 14px;">Módulo de Gestão&nbsp;&nbsp;>&nbsp;&nbsp;Relatórios
            de Gestão&nbsp;&nbsp;>&nbsp;&nbsp;Atualizar Movimento Estoque Loja</span>
    ...
    <div class="accountInfo">
        <fieldset class="login">
            <legend>Atualizar Movimento Estoque Loja</legend>
        ...
        <div>
            <asp:Button runat="server" ID="btGravaMovimento" Text="Gravar Movimento Estoque"
